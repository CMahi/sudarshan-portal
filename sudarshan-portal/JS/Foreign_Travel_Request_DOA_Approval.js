    ...
    try {
        if (fromDate != "" && toDate != "") {
            ...
            if ($("#pk_country_id").val() != 0 && $("#pk_country_id").val() != undefined) {
                ...
                Foreign_Travel_Request_DOA_Approval.getDataRows(fromDate, toDate, country_id, wiid,desg, callback_DataRows);
...
function show_record() {
    ...
    Foreign_Travel_Request_DOA_Approval.show_Policy(Desig, getPolicySucceeded)
}

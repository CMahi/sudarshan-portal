    ...
    try {
        ...
        if (fromDate != "" && toDate != "") {
            ...
            if ($("#ddlCountry").val() != 0 && $("#ddlCountry").val() != undefined) {
                ...
                check_Exist(fromDate, toDate);
                Foreign_Travel_Request.getDataRows(fromDate, toDate, country_id, $("#span_grade").text(), $("#txt_Class").val(), exc_rate, base_currency, callback_DataRows);
            }
            else {
                $("#accordion").html("");
            }
...
function getSelectDate1(fromDate, toDate) {
    try {
        var check_FromDate = check_TODate = "";
        check_FromDate = fromDate;
        check_TODate = toDate;
        if (fromDate != "" && toDate != "") {
            ...
            if ($("#ddlCountry").val() != 0 && $("#ddlCountry").val() != undefined) {
                var country_id = $("#ddlCountry").val();
                check_Exist(fromDate, toDate);
                Foreign_Travel_Request.getDataRows(fromDate, toDate, country_id, $("#span_grade").text(), $("#txt_Class").val(), exc_rate, callback_DataRows1);
            }
            else {
                $("#accordion").html("");
            }
...
function check_Exist(fromDate, toDate) {
    Foreign_Travel_Request.check_exist(fromDate, toDate, $("#txt_Username").val(), $("#ddlCountry").val(), callback_Exist);
}
...
function callback_DataRows1(response) {
    $("#accordion").html(response.value);
            ...
            for (var i = 1; i <= rws.length; i++) {
                ...
                for (var eh = 1; eh <= rowIndex - 1; eh++) {
                    ...
                    if ($("#expense_id" + i + "_" + eh).val() != undefined && $("#expense_id" + i + "_" + eh).val() != "0") {
                        ...
                        if (exp_amt != undefined && xml_exp != "0.00") {
                        ...
                        if (eh != 2) {
                            ...
                            if (SUPPORT_DOC == "Y") {
                                ...
                                xml_exp += "<SUPPORT_DOC>" + SUPPORT_DOC + "</SUPPORT_DOC>";
                                xml_exp += "<OTHER_REMARK>" + $("#other_remark_" + i + "_" + eh).val() + "</OTHER_REMARK>";
                            }
                        }
                        else {
                            xml_exp += "<SUPPORT_DOC>N</SUPPORT_DOC>";
                            xml_exp += "<OTHER_REMARK></OTHER_REMARK>";
                        }
                ...
                for (var j = 0; j < Loc_rowIndex - 1; j++) {
                    if ($("#txt_Date" + (i) + "" + (j + 1) + "").val().trim() != "" && $("#txt_From" + (i) + "" + (j + 1) + "").val().trim() != "") {
                        ...
                        if ($("#txt_From" + (i) + "" + (j + 1) + "").val().trim() == "") {
                            ...
                            alert("Please Enter Mode of Travel on " + firstDate + " at Row No : " + (j + 1) + ".!");
                            document.getElementById("txt_Travel_Mode" + (i) + "" + (j + 1) + "").focus();
                            return false;
                        }
                        else if ($("#txt_Expenses" + (i) + "" + (j + 1) + "").val().trim() == "" && $("#txt_ReimType" + i + "_" + (j + 1) + " option:selected").text() != "Corporate Credit Card" && $("#txt_ReimType" + i + "_" + (j + 1) + " option:selected").text() != "Personal Credit Card") {
                    ...
                    Local_travel += "<ROW>";
                    Local_travel += "<FK_HDR_ID>#</FK_HDR_ID>";
                ...
                if ($("#ddlCountry option:selected").index() != 0) {
                    if ($("#span_Approver").html().trim() != "") {
                        if ($("#req_remark").val().trim() != "") {
                            ...
                            for (var i = 1; i <= rows.length; i++) {
                                ...
                                for (var eh = 1; eh <= row_index - 1; eh++) {
                                    ...
                                    if ($("#expense_id" + i + "_" + eh).val() != undefined && $("#expense_id" + i + "_" + eh).val() != "0") {
                                        ...
                                        if ($("#expense_id" + i + "_" + eh).val() == "0") {
                                            alert("Please Select Expense Head For " + row_date);
                                            $("#expense_id" + i + "_" + eh).focus();
                                            return false;
                                        }

                                        if ($("#ddlrem_" + i + "_" + eh).val() == "0") {
                                            alert("Please Select Reimbursement Type For " + row_date);
                                            $("#ddlrem_" + i + "_" + eh).focus();
                                            return false;
                                        }

                                        if ($("#cur_" + i + "_" + eh).val().trim() == "") {
                                        ...
                                        if (Support_tot != "0" || Non_Support_tot != "0") {
                            ...
                            if (Class != "0" || $("#txt_Do_Limit").val() != "0" || DO_Support_Counter != "0") {
...
function Save_As_Draft() {
    ...
    try {
        ...
        for (var i = 1; i <= rws.length; i++) {
            ...
            for (var eh = 1; eh <= rowindex - 1; eh++) {
                ...
                if ($("#expense_id" + i + "_" + eh).val() != undefined && $("#expense_id" + i + "_" + eh).val() != "0") {
                    ...
                    if ($("#expense_id" + i + "_" + eh).val() != "0") {
                        ...
                        xml_exp += "<fk_expense_head_id>0</fk_expense_head_id>";
                    }
                    var exp_amt = $("#txt_Expense_Amt" + i + "_" + eh).val();
            ...
            //Local Travel XML
            var rowIndex = document.getElementById("tbl_Local_Travel" + (i) + "").rows.length;
...
function validate_DraftControls() {
    if (($("#txt_Username").val()).trim() != "") {
...
function copyData(row_index) {
    ...
    if (j1_index > 0 && jc_index == 0) {
        ...
        getCity(row_index);
        if ($("#ddlCity" + row_index).val() == -1) {
            $("#other_f_city" + row_index).val($("#other_f_city1").val());
        }
        ...
        $("#ddlTravel_class" + row_index).val($("#ddlTravel_class1").val());
    }
}
...
function change_radio(row_index) {
   ...
   for (var i = 1; i <= rws.length; i++) {
     ...
     $("#spn_Detail_Base"+row_index+"" + i).text($("#currency_adv" + row_index).val());
    ...
    var fromDate = $("#travelFromDate").val();
    var toDate = $("#travelToDate").val();
    //getSelectDate1(fromDate, toDate);
    calculate_Amount();
}
                ...
                if ($("#expense_id" + i + "_" + eh).val() != undefined && $("#expense_id" + i + "_" + eh).val() != "0") {
                   ...
                   /* if (e_name == "Conveyance") {
                    ...
                    if (($("#ddlrem_" + i + "_" + eh).find("option:selected").text() == "Corporate Credit Card") || ($("#ddlrem_" + i + "_" + eh).find("option:selected").text() == "Personal Credit Card")) {
                        ...
                        if ($("#ddlrem_" + i + "_" + eh).find("option:selected").text() == "Corporate Credit Card" || $("#ddlrem_" + i + "_" + eh).find("option:selected").text() == "Forex Card") {
                            $("#Tax" + i + "_" + eh).attr('readonly', true);
                        }
                        else {
                            $("#Tax" + i + "_" + eh).attr('readonly', false);
                        }
                        $("#dollar_" + i + "_" + eh).hide();
                        $("#dollar_" + i + "_" + eh).html();
                        $("#rupees_" + i + "_" + eh).hide();
                        ...
                        if (e_name == "Incidental") {
                            ...
                            $("#txt_Expense_Amt" + i + "_" + eh).attr('readonly', false);
                        }
                        if ($("#ddlrem_" + i + "_" + eh).find("option:selected").text() == "Corporate Credit Card" || $("#ddlrem_" + i + "_" + eh).find("option:selected").text() == "Forex Card") {
                            $("#Tax" + i + "_" + eh).attr('readonly', true);
                        }
        ...
        //if (row_id != "1") {
            ...
            for (var j = 0; j < rowIndex - 1; j++) {
                if ($("#expense_id" + tab_id + "_" + (j + 1) + "").val() == $("#expense_id" + tab_id + "_" + row_id + "").val() && (j + 1) != row_id) {
                    if ($("#ddlrem_" + tab_id + "_" + (j + 1) + "").val() == $("#ddlrem_" + tab_id + "_" + row_id + "").val() && $("#ddl_SUP_" + tab_id + "_" + (j + 1) + "").val() == $("#ddl_SUP_" + tab_id + "_" + row_id + "").val() && (j + 1) != row_id) {
                        count++;
                    }
                }
            }
            ...
            if ($("#ddlrem_" + tab_id + "_" + row_id + "").val() != "0") {
                Foreign_Travel_Request.chagable_or_not("International Travel Expenses", $("#ddlrem_" + tab_id + "_" + row_id + "").val(), data, changeText);
            }
      //  }
...
function Flag_Status(flag_Set) {
    $("#txt_DO_Status").val(flag_Set);
    return true;
}
...
function show_record() {
    ...
    Foreign_Travel_Request.show_Policy(Desig, getPolicySucceeded)
}
...
function newRow(table_row_id) {
    try {
        ...
        var dropData = Foreign_Travel_Request.getDropDownData();
        var Selected_Date = $("#txt_Date" + (table_row_id) + "" + (rowIndex-1) + "").val();
        Html = '<tr>';
        ...
        Html += '<td style="display:none"><input type="text"  id=txt_Date' + (table_row_id) + '' + (rowIndex) + ' value=' + Selected_Date + ' readonly class="form-control input-sm" style="width:121%;background-color:#ffffff;" /></td>';
        ...
        Html += '<td><input type="text" id=txt_L_Tax' + (table_row_id) + '' + (rowIndex) + ' onkeyup="calculate_Amount();" class="form-control input-sm numbersOnly" onkeyup="calculate_Amount();" /></td>';
...
function delete_Row(table_index, RowIndex) {
    try {
        ...
        for (var contolIndex = RowIndex; contolIndex <= lastRow - 1; contolIndex++) {
            ...
            $("#add" + (table_index) + "" + (parseInt(contolIndex) + 1)).attr("onclick", "newRow(" + table_index + ")");
            $("#add" + (table_index) + "" + (parseInt(contolIndex) + 1)).attr("id", "add" + (table_index) + "" + contolIndex);
            $("#delete" + (table_index) + "" + (parseInt(contolIndex) + 1)).attr("onclick","delete_Row(" + (table_index) + "," + (contolIndex) + ")");
            $("#delete" + (table_index) + "" + (parseInt(contolIndex) + 1)).attr("id","delete" + (table_index) + "" + contolIndex);
            $("#txt_Date" + (table_index) + "" + (parseInt(contolIndex) + 1)).attr("id", "txt_Date" + (table_index) + "" + contolIndex);
            $("#txt_ReimType" + (table_index) + "_" + (parseInt(contolIndex) + 1)).attr("onchange", "change_detail_flag(" + table_index + "," + contolIndex + ")");
            $("#txt_ReimType" + (table_index) + "_" + (parseInt(contolIndex) + 1)).attr("id", "txt_ReimType" + (table_index) + "_" + contolIndex);
            $("#txt_From" + (table_index) + "" + (parseInt(contolIndex) + 1)).attr("id","txt_From" + (table_index) + "" + contolIndex);
            $("#txt_To" + (table_index) + "" + (parseInt(contolIndex) + 1)).attr("id", "txt_To" + (table_index) + "" + contolIndex);
            $("#txt_Travel_Mode" + (table_index) + "" + (parseInt(contolIndex) + 1)).attr("id", "txt_Travel_Mode" + (table_index) + "" + contolIndex);
            $("#txt_Expenses" + (table_index) + "" + (parseInt(contolIndex) + 1)).attr("onkeyup", "calculate_Amount()");
            $("#txt_Expenses" + (table_index) + "" + (parseInt(contolIndex) + 1)).attr("id","txt_Expenses" + (table_index) + "" + contolIndex);
            $("#txt_L_Tax" + (table_index) + "" + (parseInt(contolIndex) + 1)).attr("onkeyup","calculate_Amount()");
            $("#txt_L_Tax" + (table_index) + "" + (parseInt(contolIndex) + 1)).attr("id", "txt_L_Tax" + (table_index) + "" + contolIndex);
            $("#txt_L_Rate" + (table_index) + "" + (parseInt(contolIndex) + 1)).attr("onkeyup", "calculate_Amount()");
            $("#txt_L_Rate" + (table_index) + "" + (parseInt(contolIndex) + 1)).attr("id", "txt_L_Rate" + (table_index) + "" + contolIndex);
            $("#spn_L_BAmount" + (table_index) + "" + (parseInt(contolIndex) + 1)).attr("id", "spn_L_BAmount" + (table_index) + "" + contolIndex);
            $("#spn_L_Amount" + (table_index) + "" + (parseInt(contolIndex) + 1)).attr("id", "spn_L_Amount" + (table_index) + "" + contolIndex);
            $("#txt_L_BAmount" + (table_index) + "" + (parseInt(contolIndex) + 1)).attr("onkeyup", "calculate_Amount()");
            $("#txt_L_BAmount" + (table_index) + "" + (parseInt(contolIndex) + 1)).attr("id", "txt_L_BAmount" + (table_index) + "" + contolIndex);
            $("#txt_L_Amount" + (table_index) + "" + (parseInt(contolIndex) + 1)).attr("id", "txt_L_Amount" + (table_index) + "" + contolIndex);
            $("#txt_Remark" + (table_index) + "" + (parseInt(contolIndex) + 1)).attr("id","txt_Remark" + (table_index) + "" + contolIndex);
            $("#txt_Bill" + (table_index) + "" + (parseInt(contolIndex) + 1)).attr("id","txt_Bill" + (table_index) + "" + contolIndex);
        }
        //tbl.deleteRow(RowIndex);
        calculate_Amount();
    }
...
function Add_Multiple_Row(row_id) {
    try {
        ...
        if ($("#ddlCountry").val() != 0 && $("#ddlCountry").val() != undefined) {
            var country_id = $("#ddlCountry").val();
            Foreign_Travel_Request.getmultiplerows(row_id, rowIndex, country_id, $("#span_grade").text(), $("#ddlCity" + (row_id) + "").val(), callback_MultipleDataRows);
        }
    }
    catch (Ex) {
        alert(Ex);
...
function get_Limit(tab_id, row_index) {
    try {
        ...
        if ($("#expense_id" + tab_id + "_" + row_index + "").val() != "0" && ($("#ddlCountry").val() != "0")) {
            Foreign_Travel_Request.get_inc_limits($("#ddlCountry").val(), $("#span_grade").text(), $("#expense_id" + tab_id + "_" + row_index + "").find('option:selected').text(), data, $("#ddlCity" + tab_id + "").val(), getexp_limit);
        }
    }
    catch (Ex) {
        alert(Ex);
...
function Supporting_Doc_Check(rowid) {
    ...
    for (var j = 0; j < local_tab - 1; j++) {
        if (($("#txt_Bill" + (rowid) + "" + (j + 1) + "").val() != "0") && ($("#txt_Bill" + (rowid) + "" + (j + 1) + "").val() == "N") && ($("#txt_Expenses" + (rowidrowid) + "" + (j + 1) + "").val() != "") && (($("#txt_Expenses" + (rowid) + "" + (j + 1) + "").val() != "0"))) {
...
function getLocalRows(tab_id,row_date)
{
    ...
    try {
        var reim_data = Foreign_Travel_Request.getReimTypes();

...
var details = "";
function FillVehicleType(id) {

    try {
        var str = document.getElementById("txt_vehitype1").value;
...
function createxml() {
    try {
                ...
                var tbllength = $('#tbl_Local tr').length - 1;
                ...
                for (var q = 1; q <= tbllength; q++) {
                    ...
                    xmlvehicle += "|ROW||";
                    xmlvehicle += "|FK_Local_Conveyance_HDR_Id||" + pk_id  + "|/FK_Local_Conveyance_HDR_Id||";

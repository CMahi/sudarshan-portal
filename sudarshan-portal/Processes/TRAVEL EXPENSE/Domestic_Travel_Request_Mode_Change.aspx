<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Domestic_Travel_Request_Mode_Change.aspx.cs" Inherits="Domestic_Travel_Request_Mode_Change" %>
...
<body>
    <form id="form1" runat="server">
            ...
            <div class="col-md-12">
                ...
                <div class="panel panel-danger">
                    <div class="panel-heading">
                        ...
                        <h3 class="panel-title">DOMESTIC TRAVEL EXPENSE - CHANGE PAYMENT MODE</h3>
                    </div>
                    <div class="panel-body" id="div_hdr">
                        <div class="form-horizontal">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-2">
                                    <div id="Div10">
                                        <%--<span id="pay_mode" runat="server"></span>--%>
                                ...
                                <div class="col-md-2" id="ctrlPay" runat="server" style="display:none">
                                    <div id="Div12">
                                        <%--<span id="pay_location" runat="server"></span>--%>
        ...
        <div style="display: none">
            ...
            <asp:TextBox ID="advance_amount" runat="server" Text="0"></asp:TextBox>
        </div>
        <!-- ================== BEGIN BASE JS ================== -->
        ...
        <script src="../../JS/Domestic_Travel_Request_Mode_Change.js"></script>
    </form>
</body>
</html>

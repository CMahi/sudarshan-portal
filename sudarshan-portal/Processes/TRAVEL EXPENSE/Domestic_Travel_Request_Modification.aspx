<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Domestic_Travel_Request_Modification.aspx.cs" Inherits="Domestic_Travel_Request_Modification" EnableEventValidation="false" ValidateRequest="false" %>
                        ...
                        <div class="row">
                            <div class="form-horizontal">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-3">
                                        <div id="Div9"><b><span id="span_Division" runat="server"></span></b></div>
                                    </div>
                                        </div>
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-3">
                                        <div id="Div11"><span id="spn_base_location" runat="server">NA</span></div>
                                    </div>
                                        </div>
                                </div>
                                 <div class="form-group">
            ...
            <div class="col-md-12">
                ...
                <div class="panel panel-danger">
                    <div class="panel-heading">
                         ...
                         <h3 class="panel-title">DOMESTIC TRAVEL EXPENSE - MODIFICATION</h3>
                    </div>
                              ...
                              <div class="form-group">
                               ...
                               <div class="form-group">
                                ...
                                <div class="col-md-2">
                                    ...
                                    <div class="col-md-1"></div>
                                <label class="col-md-2" id="lblPay" runat="server" style="display:none">Payment Location</label>
                                <div class="col-md-2" id="ctrlPay" runat="server" style="display:none">
            ...
            <div class="col-md-12">
				...
				<div class="panel panel-grey">
					<div class="panel-heading">
                         ...
                         <div class="panel-heading-btn">
                                    <b>Total Amount : </b>
                                    <span id="Final_Amtt" runat="server" style="display:normal">0 <i class="fa fa-rupee" ></i></span>
                ...
                <div class="panel panel-grey">
                    ...
                    <div class="panel-body">
                        ...
                        <div class="col-md-6">
                            ...
                            <%--<asp:Button ID="btnSave" runat="server" Text="Save As Draft" class="btn btn-sm btn-default" OnClientClick="return save_as_draft()" OnClick="btnSave_Click" />--%>
...
<div class='col-md-12'>
        ...
        <div style="display: none">
            ...
            <asp:TextBox ID="txt_chkbox" runat="server" Text="0"></asp:TextBox>       
        </div>
        <!-- ================== BEGIN BASE JS ================== -->
        ...
        <script src="../../JS/Domestic_Travel_Request_Modification.js"></script>
    </form>
</body>
</html>

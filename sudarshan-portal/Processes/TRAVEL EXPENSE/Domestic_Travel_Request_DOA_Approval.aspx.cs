...
public partial class Domestic_Travel_Request_DOA_Approval : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        try
        {
            ...
            {
                AjaxPro.Utility.RegisterTypeForAjax(typeof(Domestic_Travel_Request_DOA_Approval));
                if (!Page.IsPostBack)
                {

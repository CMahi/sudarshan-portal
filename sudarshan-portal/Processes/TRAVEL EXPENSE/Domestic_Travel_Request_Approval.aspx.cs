...
public partial class Domestic_Travel_Request_Approval : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        try
        {
            ...
            {
                AjaxPro.Utility.RegisterTypeForAjax(typeof(Domestic_Travel_Request_Approval));
                if (!Page.IsPostBack)
                {
    ...
    private void fillAdvanceAmount()
    {
        ...
        try
        {
            ...
            tblHTML.Append("<table ID='tblAdvance' class='table table-bordered'><thead><tr class='grey'><th>#</th><th>Request No</th><th>Advance Date</th><th>Advance Amount (<i class='fa fa-rupee'></i>)</th><th>Approved By</th></tr></thead>");
            tblHTML.Append("<tbody>");
        ...
        try
        {
            ...
            else
            {
                if (ddlAction.SelectedIndex > 0)
                {
                    ...
                    {
                        if (dev_policy_amt.Text != "1" && dev_travel_class.Text != "1" && dev_supp_amt.Text != "1")
                        {
                            ...
                            if (DTAP != null)
                            {
                                if (DTAP.Rows.Count > 0)
                                {
                                    ...
                                    else
                                    {
                                        ...
                                        bool isCreate = (bool)WFE.Action.ReleaseStep(txtProcessID.Text, txtInstanceID.Text, "172", "TRAVEL EXPENSE APPROVAL", "SUBMIT", txt_Username.Text, txt_Username.Text.Trim(), "", "", "", "", "", "", "", "", "", "", Dval, spn_req_no.InnerHtml, txtWIID.Text, ref isInserted);
                                        if (isCreate)
                                        {
                                            try
                                            {
                                                string auditid = (string)ActionController.ExecuteAction(txt_initiator.Text, "Domestic_Travel_Request.aspx", "insertaudittrail", ref isInserted, txtProcessID.Text, txtInstanceID.Text, "TRAVEL EXPENSE APPROVAL", "USER", txt_Username.Text, "SUBMIT", "Send For Document Approval", "0", "0");
                                                ...
                                                string emailid = (string)ActionController.ExecuteAction(txt_Username.Text, "Domestic_Travel_Request.aspx", "insetmaildata", ref isInserted, txtProcessID.Text, txtInstanceID.Text, 0, "TRAVEL EXPENSE APPROVAL", "SUBMIT", txt_init_mail.Text, txtApproverEmail.Text, msg, "Request No: " + spn_req_no.InnerHtml);
                                            }
                                            catch (Exception)
                                            {
                                                throw;
                        ...
                        else
                        {
                            if (doa_user.Text != "NA" && doa_user.Text != "")
                            {
                                ...
                                {
                                    if (span_Approver.InnerHtml != span_DApprover.InnerHtml)
                                    {
                                        string[] Dval = new string[1];
                                        Dval[0] = doa_user.Text;

                                        bool isCreate = (bool)WFE.Action.ReleaseStep(txtProcessID.Text, txtInstanceID.Text, "171", "TRAVEL EXPENSE APPROVAL", "DOA-SUBMIT", txt_Username.Text, txt_Username.Text.Trim(), "", "", "", "", "", "", "", "", "", "", Dval, spn_req_no.InnerHtml, txtWIID.Text, ref isInserted);
                                        if (isCreate)
                                        {
                                            try
                                            {
                                                string auditid = (string)ActionController.ExecuteAction(txt_initiator.Text, "Domestic_Travel_Request.aspx", "insertaudittrail", ref isInserted, txtProcessID.Text, txtInstanceID.Text, "TRAVEL EXPENSE APPROVAL", "USER", txt_Username.Text, "DOA-SUBMIT", "Send For Deviation Approval", "0", "0");

                                                string msg = "<pre><font size='3'>Dear Sir/Madam,</font></pre><pre><font size='3'>>Domestic Travel Request Has Been Approved and Sent For Deviation Approval.</font></pre><pre><font size='3'>Request No: " + spn_req_no.InnerHtml + "</font></pre><pre><font size='3'>Created By: " + span_ename.InnerHtml.Trim() + "</font></pre><pre><pre>INTRANET URL:http://" + compname + "/Sudarshan-Portal/Login.aspx</pre><pre>INTERNET URL:https://" + compname + "/Sudarshan-Portal/Login.aspx</pre><pre></pre><pre><font size='3'  color='red'><i><b>This is a system generated message. We request you not to reply to this message.</b></i></font></pre>";

                                                string emailid = (string)ActionController.ExecuteAction(txt_Username.Text, "Domestic_Travel_Request.aspx", "insetmaildata", ref isInserted, txtProcessID.Text, txtInstanceID.Text, 0, "TRAVEL EXPENSE APPROVAL", "DOA-SUBMIT", doa_email.Text, txt_init_mail.Text, msg, "Request No: " + spn_req_no.InnerHtml);
                                            }
                                            catch (Exception)
                                            {
                                                throw;
                                            ...
                                            {
                                                Page.RegisterStartupScript("onclick", "<script language='javascript'>{alert('Domestic Travel Request Has Been Approved and Sent For Deviation Approval...!');window.open('../../Portal/SCIL/Home.aspx','frmset_WorkArea');}</script>");
                                            }
                                        }
                                    }
                                    else
                                            ...
                                            if (DTAP.Rows.Count > 0)
                                            {
                                                ...
                                                if (isCreate)
                                                {
                                                    try
                                                    {
                                                        ...
                                                        isCreate = (bool)WFE.Action.ReleaseStep(txtProcessID.Text, txtInstanceID.Text, "175", "TRAVEL EXPENSE DEVIATION APPROVAL", "SUBMIT", txt_Username.Text, txt_Username.Text.Trim(), "", "", "", "", "", "", "", "", "", "", Dval1, spn_req_no.InnerHtml, wiid, ref isInserted);
                                                        if (isCreate)
                                                        {
                                                            ...
                                                            auditid = (string)ActionController.ExecuteAction(txt_initiator.Text, "Domestic_Travel_Request.aspx", "insertaudittrail", ref isInserted, txtProcessID.Text, txtInstanceID.Text, "TRAVEL EXPENSE DEVIATION APPROVAL", "USER", txt_Username.Text, "SUBMIT", "Send For Document Approval", "0", "0");
                                                            string emailid = (string)ActionController.ExecuteAction(txt_Username.Text, "Domestic_Travel_Request.aspx", "insetmaildata", ref isInserted, txtProcessID.Text, txtInstanceID.Text, 0, "TRAVEL EXPENSE DEVIATION APPROVAL", "SUBMIT", txtApproverEmail.Text, txt_init_mail.Text, msg, "Request No: " + spn_req_no.InnerHtml);
                    ...
                    else if (ddlAction.SelectedValue == "2")
                    {
                        ...
                        else
                        {
                            ...
                            bool isCreate = (bool)WFE.Action.ReleaseStep(txtProcessID.Text, txtInstanceID.Text, "173", "TRAVEL EXPENSE APPROVAL", "SEND-BACK", txt_Username.Text, txt_initiator.Text.Trim(), txt_initiator.Text.Trim(), "", "", "", "", "", "", "", "", "", Dval, spn_req_no.InnerHtml, txtWIID.Text, ref isInserted);
                            if (isCreate)
                            {
                                try
                                {
                                    string auditid = (string)ActionController.ExecuteAction(txt_initiator.Text, "Domestic_Travel_Request.aspx", "insertaudittrail", ref isInserted, txtProcessID.Text, txtInstanceID.Text, "TRAVEL EXPENSE APPROVAL", "USER", txt_Username.Text, "SEND-BACK", txt_Remark.Text, "0", "0");

                                    string msg = "<pre><font size='3'>Dear Sir/Madam,</font></pre><pre><font size='3'>Domestic Travel Request Has Been Sent Back To Initiator For Modification.</font></pre><pre><font size='3'>Request No: " + spn_req_no.InnerHtml + "</font></pre><pre><font size='3'>Created By: " + span_ename.InnerHtml.Trim() + "</font></pre><pre>INTERNET URL:https://" + compname + "/Sudarshan-Portal/Login.aspx</pre><pre></pre><pre><font size='3'  color='red'><i><b>This is a system generated message. We request you not to reply to this message.</b></i></font></pre>";

                                    string emailid = (string)ActionController.ExecuteAction(txt_Username.Text, "Domestic_Travel_Request.aspx", "insetmaildata", ref isInserted, txtProcessID.Text, txtInstanceID.Text, 0, "TRAVEL EXPENSE APPROVAL", "SEND-BACK", txt_init_mail.Text, "", msg, "Request No: " + spn_req_no.InnerHtml);
                                }
                                catch (Exception)
                                {
                                    throw;
                    ...
                    else if (ddlAction.SelectedValue == "3")
                    {
                        ...
                        else
                        {
                            ...
                            bool isCreate = (bool)WFE.Action.ReleaseStep(txtProcessID.Text, txtInstanceID.Text, "174", "TRAVEL EXPENSE APPROVAL", "REJECT", txt_Username.Text, txt_Username.Text.Trim(), "", "", "", "", "", "", "", "", "", "", Dval, spn_req_no.InnerHtml, txtWIID.Text, ref isInserted);
                            if (isCreate)
                            {
                                try
                                {
                                    string auditid = (string)ActionController.ExecuteAction(txt_initiator.Text, "Domestic_Travel_Request.aspx", "insertaudittrail", ref isInserted, txtProcessID.Text, txtInstanceID.Text, "TRAVEL EXPENSE APPROVAL", "USER", txt_Username.Text, "REJECT", txt_Remark.Text, "0", "0");

                                    string msg = "<pre><font size='3'>Dear Sir/Madam,</font></pre><pre><font size='3'>Domestic Travel Request Has Been Rejected.</font></pre><pre><font size='3'>Request No: " + spn_req_no.InnerHtml + "</font></pre><pre><font size='3'>Created By: " + span_ename.InnerHtml.Trim() + "</font></pre><pre>INTERNET URL:https://" + compname + "/Sudarshan-Portal/Login.aspx</pre><pre></pre><pre><font size='3'  color='red'><i><b>This is a system generated message. We request you not to reply to this message.</b></i></font></pre>";

                                    string emailid = (string)ActionController.ExecuteAction(txt_Username.Text, "Domestic_Travel_Request.aspx", "insetmaildata", ref isInserted, txtProcessID.Text, txtInstanceID.Text, 0, "TRAVEL EXPENSE APPROVAL", "REJECT", txt_init_mail.Text, "", msg, "Request No: " + spn_req_no.InnerHtml);
                                }
                                catch (Exception)
                                {
                                    throw;

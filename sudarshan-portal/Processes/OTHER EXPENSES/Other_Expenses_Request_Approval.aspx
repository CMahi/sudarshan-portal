<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Other_Expenses_Request_Approval.aspx.cs" Inherits="Other_Expenses_Request_Approval" %>
...
<body>
    <form id="form1" runat="server">        
                ...
                <div class="panel panel-danger">
                    <div class="panel-heading">
                            ...
                            <a href="#div_user_data" data-toggle="modal" title="Requestor's Detail" style="color:blue"><i class="fa fa-fw m-r-10 pull-left f-s-18 fa-user"></i></a>
                                     ...
                                     <h3 class="panel-title">OTHER EXPENSE - REQUEST APPROVAL</h3>
        ...
        <div style="display: none">
            ...
            <asp:TextBox ID="deviate" runat="server"></asp:TextBox>
    ...
    window.open(app_path + '/Common/FileDownload.aspx?indentno=' + req_no + '&filename=' + index + '&filetag=', 'Download', 'left=150,top=100,width=600,height=300,toolbar=no,menubars=no,status=no,scrollbars=yes,resize=no');
            ...
            function checkRemark()
            {
                ...
                if ($("#ddlAction option:selected").val() < 2) {
            ...
            function PrepareData()
            {
                if ($("#ddlAction option:selected").val() == 0) {
                    ...
                    else if ($("#ddlAction option:selected").val() == 1)
                    {
                        var dev = $("#deviate").val();
                        if (dev == 1 && ($("#doa_user").val() == "NA" || $("#doa_user").val() == "" || $("#doa_user").val() == "0"))
                        {
                            alert("Deviation Approver Not Found. Unbale To Proceed Request...!");
                            return false;
                        }
                    }
                    return true;

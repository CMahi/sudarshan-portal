<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Foreign_Travel_Request_Doc_Verification.aspx.cs" Inherits="Foreign_Travel_Request_Doc_Verification" %>
...
<body>
  	<form id="form1" runat="server">
            ...
            <div class="col-md-12">
                <div class="panel panel-danger">
                    <div class="panel-heading">
                        ...
                        <h3 class="panel-title">FOREIGN TRAVEL EXPENSE - DOCUMENT VERIFICATION</h3>
                        ...
                        <div class="form-horizontal">
                           ...
                           <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-1"></div>
                                <div class="col-md-4">
                                    <input type="checkbox" id="chk_original" /> Original Document Submitted?
                                </div>
                            </div>
        ...
        <script src="../../JS/Foreign_Travel_Request_Doc_Verification.js"></script>
    </form>
               <script>

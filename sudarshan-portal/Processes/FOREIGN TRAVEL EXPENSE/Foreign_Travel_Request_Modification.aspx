<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Foreign_Travel_Request_Modification.aspx.cs" Inherits="Foreign_Travel_Request_Modification" ValidateRequest="false" EnableEventValidation="false" %>
...
<body>
    <form id="form1" runat="server">
            ...
            <div class="col-md-12">
                <div class="panel panel-danger">
                    <div class="panel-heading">
                        ...
                        <h3 class="panel-title">FOREIGN TRAVEL EXPENSE - REQUEST MODIFICATION</h3>
            ...
            <div class="col-md-12">
                <div class="panel panel-grey">
                    ...
                    <div class="panel-body">
                        ...
                        <div class="col-md-6">
                            <asp:Button ID="btnSubmit" runat="server" Text="Proceed" class="btn btn-grey btn-rounded" OnClientClick="return prepare_data()" />
                            <asp:Button ID="btnDraft" runat="server" Text="Save As Draft" class="btn btn-grey btn-rounded" OnClientClick="return Save_As_Draft()" OnClick="btnDraft_Click" />
            ...
            <div class="modal fade" id="Return_Money_Div">
                ...
                <div class="modal-dialog" style="width: 90%; margin-left: 5%">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <div class="row">
                                <div class="form-horizontal" id="Hide_div">
                                    <div class="form-group">
                                        <div class="col-md-12">
                                            <div class="col-md-1"></div>
                                            ...
                                            <div class="col-md-3">
                                                <div id="Div12"><span id="S_Advance" runat="server"></span></div>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <div class="col-md-12">
                                            ...
                                            <div class="col-md-3">
                                                <div id="Div13"><span id="S_Expense" runat="server"></span></div>
                                            </div>

                                            <div class="col-md-1"></div>
                                            <label class="col-md-2">Difference</label>
                                            <div class="col-md-3">
                                                <div id="Div14"><span id="S_Diff" runat="server"></span></div>
                                            </div>
                                        </div>
                                    </div>
        ...
        <div style="display: none">
            ...
            <asp:TextBox ID="ofdate" runat="server"></asp:TextBox>
            <asp:TextBox ID="otdate" runat="server"></asp:TextBox>
            <asp:TextBox ID="txt_Doc_Verifacation_status" runat="server"></asp:TextBox>
            <asp:TextBox ID="txt_Class" runat="server"></asp:TextBox>
            <asp:TextBox ID="txt_Supporting_Limit" runat="server"></asp:TextBox>
            ...
            <asp:TextBox ID="Non_supp_Yes_no" runat="server" Text="0"></asp:TextBox>
        ...
        <script src="../../JS/Foreign_Travel_Request_Modification.js"></script>
    </form>

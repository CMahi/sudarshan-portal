...
public partial class Foreign_Travel_Request_DOA_Approval : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        try
        {
            ...
            {
                AjaxPro.Utility.RegisterTypeForAjax(typeof(Foreign_Travel_Request_DOA_Approval));
                if (!Page.IsPostBack)
                {
    ...
    protected static string bindExpense(int index, DateTime fdate, DataTable dtExp, string currency, DataTable dtDay, DataTable Loc_travel)
    {
        ...
        try
        {
            ...
            if (Loc_travel.Rows.Count > 0)
            {
                ...
                //html.Append("<thead><tr class='grey'><th>Date</th><th>From</th><th>To</th><th>Mode of Travel</th><th>Expense amount in currency spent</th><th>Tax</th><th>Remark</th><th>Bills attached Yes/No</th></tr></thead>");

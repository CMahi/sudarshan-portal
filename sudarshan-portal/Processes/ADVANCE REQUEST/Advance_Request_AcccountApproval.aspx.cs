...
public partial class Advance_Request_AcccountApproval : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        try
        {
            ...
            {
                AjaxPro.Utility.RegisterTypeForAjax(typeof(Advance_Request_AcccountApproval));
                if (!Page.IsPostBack)
                {
    ...
    private void Initialization()
    {
        try
        {
            ...
            if (dsData != null)
            {
                ...
                //txt_tremark.InnerHtml = Convert.ToString(dsData.Tables[0].Rows[0]["remkdtl"]);
    ...
    private void fillAction()
    {
        try
        {
            string Isdata = string.Empty;
            ListItem li = new ListItem("--Select One--", "");
            DataTable dt = (DataTable)ActionController.ExecuteAction("", "Advance_Request_Approval.aspx", "saction", ref Isdata);
    ...
    protected void btnRequest_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            else
            {
                ...
                txt_Audit.Text = "ADVANCE REQUEST ACCOUNT PAYABLE APPROVAL";
                    ...
                    else
                    {
                        ...
                        if (isCreate)
                        {
                            try
                            {
                                ...
                                string msg = "<pre><font size='3'>Dear Sir/Madam,</font></pre><p/> <pre><font size='3'>Advance Request Request has been Approved.</font></pre><p/> <pre><font size='3'>Request No: " + spn_req_no.InnerHtml + "</font></pre> <pre><font size='3'>Created By: " + span_ename.InnerHtml.Trim() + "</font></pre></p><pre></b><pre>INTERNET URL:https://" + compname + "/Sudarshan-Portal/Login.aspx</pre><pre></pre><pre><font size='3'  color='red'><i><b>This is a system generated message. We request you not to reply to this message.</b></i></font></pre>";

                                string emailid = (string)ActionController.ExecuteAction(txt_Username.Text, "Advance_Request.aspx", "insetmaildata", ref isInserted, txtProcessID.Text, txtInstanceID.Text, 0, "ADVANCE REQUEST ACCOUNT PAYABLE APPROVAL", "APPROVE", Init_Email.Text, txtEmailID.Text, msg, "Request No: " + spn_req_no.InnerHtml);
                            }
                            catch (Exception)
                            {
                                throw;
                            ...
                            {
                                Page.RegisterStartupScript("onclick", "<script language='javascript'>{alert('Advance Request has been Approved...!');window.open('../../Portal/SCIL/Home.aspx','frmset_WorkArea');}</script>");
                            }
                        }
                    }//
                        ...
                        if (isCreate)
                        {
                            try
                            {
                               // string auditid = (string)ActionController.ExecuteAction(txt_Initiator.Text, "Advance_Request.aspx", "insertaudittrail", ref isInserted, txtProcessID.Text, txtInstanceID.Text, "ADVANCE REQUEST ACCOUNT PAYABLE APPROVAL", "USER", txt_Username.Text, "REJECT", txtRemark.Value, "0", "0");
                                ...
                                string emailid = (string)ActionController.ExecuteAction(txt_Username.Text, "Advance_Request.aspx", "insetmaildata", ref isInserted, txtProcessID.Text, txtInstanceID.Text, 0, "ADVANCE REQUEST ACCOUNT PAYABLE APPROVAL", "REJECT", Init_Email.Text, txtEmailID.Text, msg, "Request No: " + spn_req_no.InnerHtml);
                            }
                            catch (Exception)
                            {
                                throw;
                ...
                else if (ddlAction.SelectedItem.Text == "Send-Back")
                {
                    ...
                    else
                    {
                        ...
                        bool isCreate = (bool)WFE.Action.ReleaseStep(txtProcessID.Text, txtInstanceID.Text, "167", "ADVANCE REQUEST ACCOUNT PAYABLE APPROVAL", "SEND-BACK", txt_Username.Text, txt_Approver.Text.Trim(), "", "", "", "", "", "", "", "", "", "", Dval, txt_Request.Text, txtWIID.Text, ref isInserted);
                        ...
                        if (isCreate)
                        {
                            try
                            {
                                ...
                                string emailid = (string)ActionController.ExecuteAction(txt_Username.Text, "Advance_Request.aspx", "insetmaildata", ref isInserted, txtProcessID.Text, txtInstanceID.Text, 0, "ADVANCE REQUEST ACCOUNT PAYABLE APPROVAL", "SEND-BACK", Init_Email.Text, txtEmailID.Text, msg, "Request No: " + spn_req_no.InnerHtml);
                            }
                            catch (Exception)
                            {
                                throw;
                ...
                else if (ddlAction.SelectedValue == "Send-Back-Payment")
                {
                    ...
                    else
                    {
                        string[] Dval = new string[1];
                        Dval[0] = txt_Initiator.Text;
                        bool isCreate = (bool)WFE.Action.ReleaseStep(txtProcessID.Text, txtInstanceID.Text, "240", "ADVANCE REQUEST ACCOUNT PAYABLE APPROVAL", "SEND-BACK-PAYMENT", txt_Username.Text, txt_Approver.Text.Trim(), "", "", "", "", "", "", "", "", "", "", Dval, txt_Request.Text, txtWIID.Text, ref isInserted);
                        if (isCreate)
                        {
                            try
                            {
                             ...
                             //   {
                                string msg = "<pre><font size='3'>Dear Sir/Madam,</font></pre><p/> <pre><font size='3'>Advance Request has been sent for payment mode change....</font></pre><p/> <pre><font size='3'>Request No: " + spn_req_no.InnerHtml + "</font></pre> <pre><font size='3'>Created By: " + span_ename.InnerHtml.Trim() + "</font></pre></p><pre></b><pre>INTERNET URL:https://" + compname + "/Sudarshan-Portal/Login.aspx</pre><pre></pre><br/><pre><font size='3' color='red'><i><b>This is a system generated message. We request you not to reply to this message.</b></i></font></pre>";
                                    string emailid = (string)ActionController.ExecuteAction(txt_Username.Text, "Advance_Request.aspx", "insetmaildata", ref isInserted, txtProcessID.Text, txtInstanceID.Text, 0, "ADVANCE REQUEST ACCOUNT PAYABLE APPROVAL", "SEND-BACK-PAYMENT", Init_Email.Text, txtEmailID.Text, msg, "Request No: " + spn_req_no.InnerHtml);
                              //  }
                            }
                            catch (Exception)
                            {
                            ...
                            {
                                Page.RegisterStartupScript("onclick", "<script language='javascript'>{alert('Advance Request has been sent for payment mode change...!');window.open('../../Portal/SCIL/Home.aspx','frmset_WorkArea');}</script>");
                            }
                        }
                    }

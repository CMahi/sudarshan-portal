...
public partial class Advance_Request_Approval : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        try
        {
            ...
            {
                AjaxPro.Utility.RegisterTypeForAjax(typeof(Advance_Request_Approval));
                if (!Page.IsPostBack)
                {
                ...
                spn_base_location.InnerHtml = Convert.ToString(dtUser.Rows[0]["BASE_LOCATION"]);
                    ...
                    if (dtApprover != null)
                    {
                        if (dtApprover.Rows.Count > 0)
                        {
                            ...
                            //span_Approver.InnerHtml = span_DApprover.InnerHtml = "pvshinde";
    ...
    protected void btnRequest_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            else
            {
                ...
                txt_Audit.Text = "ADVANCE REQUEST APPROVAL";
                if (ddlAction.SelectedItem.Text == "Approve")
                {
                            ...
                            if (DTAP.Rows.Count > 0)
                            {
                                ...
                                else
                                {
                                    ...
                                    if (DTAP.Rows.Count > 0)
                                    {
                                        ...
                                        bool isCreate = (bool)WFE.Action.ReleaseStep(txtProcessID.Text, txtInstanceID.Text, "158", "ADVANCE REQUEST APPROVAL", "APPROVE", txt_Username.Text, txt_Username.Text.Trim(), "", "", "", "", "", "", "", "", "", "", Dval, txt_Request.Text, txtWIID.Text, ref isInserted);
                                        ...
                                        if (isCreate)
                                        {
                                            try
                                            {
                                                if (txt_paymode.Text == "1")
                                                {
                                                    ...
                                                    emailid = (string)ActionController.ExecuteAction(txt_Username.Text, "Advance_Request.aspx", "insetmaildata", ref isInserted, txtProcessID.Text, txtInstanceID.Text, 0, "ADVANCE REQUEST APPROVAL", "APPROVE", Init_Email.Text, txtApproverEmail.Text, msg, "Request No: " + spn_req_no.InnerHtml);
                                                }
                                                else
                                                {
                    ...
                    else
                    {
                        ...
                        //else
                        //{
                        //    DataTable dtA = (DataTable)ActionController.ExecuteAction("", "Advance_Request_Approval.aspx", "getadvancedeviate", ref isInserted, txtDummy.Text);
                        //    if (dtA != null && dtA.Rows.Count > 0)
                        //    {
                        //        dval = new string[dtA.Rows.Count];
                        //        for (int f = 0; f < dtA.Rows.Count; f++)
                        //        {
                        //            dval[f] = Convert.ToString(dtA.Rows[f]["ad_id"]);
                        //            if (f == 0)
                        //            {
                        //                txtApproverEmail.Text = Convert.ToString(dtA.Rows[f]["EMAIL_ID"]);
                        //            }
                        //            else
                        //            {
                        //                txtApproverEmail.Text += Convert.ToString(dtA.Rows[f]["EMAIL_ID"]);
                        ...
                        if (dval.Length > 0)
                        {
                            ...
                            else
                            {
                                ...
                                {
                                    bool isCreate = (bool)WFE.Action.ReleaseStep(txtProcessID.Text, txtInstanceID.Text, "165", "ADVANCE REQUEST APPROVAL", "DOA-SUBMIT", txt_Username.Text, txt_Username.Text.Trim(), "", "", "", "", "", "", "", "", "", "", dval, txt_Request.Text, txtWIID.Text, ref isInserted);
                                    if (isCreate)
                                    {
                                        try
                                        {
                                            string msg = "<pre><font size='3'>Dear Sir/Madam,</font></pre><p/> <pre><font size='3'>Advance Request Approved Successfully and sent for Deviation Approval.</font></pre><p/> <pre><font size='3'>Request No: " + spn_req_no.InnerHtml + "</font></pre> <pre><font size='3'>Created By: " + span_ename.InnerHtml.Trim() + "</font></pre></p><pre></b><pre>INTERNET URL:https://" + compname + "/Sudarshan-Portal/Login.aspx</pre><pre></pre><br/><pre><font size='3'  color='red'><i><b>This is a system generated message. We request you not to reply to this message.</b></i></font></pre>";
                                            string emailid = (string)ActionController.ExecuteAction(txt_Username.Text, "Advance_Request.aspx", "insetmaildata", ref isInserted, txtProcessID.Text, txtInstanceID.Text, 0, "ADVANCE REQUEST APPROVAL", "DOA-SUBMIT", txtApproverEmail.Text, Init_Email.Text, msg, "Request No: " + spn_req_no.InnerHtml);
                                        }
                                        catch (Exception)
                                        {
                                            throw;
                                        ...
                                        {
                                            Page.RegisterStartupScript("onclick", "<script language='javascript'>{alert('Advance Request Approved Successfully and sent for Deviation Approval..!');window.open('../../Portal/SCIL/Home.aspx','frmset_WorkArea');}</script>");
                                        }
                                    }
                                }
                                else
                                {
                                    DataTable DTAP = new DataTable();
                                    txt_Audit1.Text = "ADVANCE REQUEST DEVIATION APPROVAL";
                                    string msg = "";
                                    string emailid = string.Empty;
                                    CryptoGraphy crypt = new CryptoGraphy();
                                    string req_no = crypt.Encryptdata(txt_Request.Text);
                                    ...
                                    if (DTAP != null)
                                    {
                                        ...
                                        {
                                            txt_Condition.Text = "3";
                                            //string isSaved1 = (string)ActionController.ExecuteAction("", "Advance_Request_Approval.aspx", "updatetwi", ref ref_data, Convert.ToInt32(txt_Condition.Text), txtProcessID.Text, txtInstanceID.Text, txt_Audit1.Text, txt_Username.Text, remark, ddlAction.SelectedItem.Text, txt_Request.Text);
                                            string isSaved1 = (string)ActionController.ExecuteAction("", "Advance_Request.aspx", "inserttwi", ref ref_data, txtProcessID.Text, txtInstanceID.Text, txt_Username.Text, txt_Request.Text, "7");
                                            ...
                                            else
                                            {
                                              ...
                                              //  Dval1[0] = "";
                                                if (DTAP.Rows.Count > 0)
                                                {
                                                    ...
                                                    bool isCreate = (bool)WFE.Action.ReleaseStep(txtProcessID.Text, txtInstanceID.Text, "158", "ADVANCE REQUEST APPROVAL", "APPROVE", txt_Username.Text, txt_Username.Text.Trim(), "", "", "", "", "", "", "", "", "", "", Dval1, txt_Request.Text, txtWIID.Text, ref isInserted);
                                                    ...
                                                    if (isCreate)
                                                    {
                                                        try
                                                        {
                                                            if (txt_paymode.Text == "1")
                                                            {
                                                                msg = "<pre><font size='3'>Dear Sir/Madam,</font></pre><p/> <pre><font size='3'>Advance Request has been sent to Accounts for payment approval. .!</font></pre><p/> <pre><font size='3'>Request No: " + spn_req_no.InnerHtml + "</font></pre> <pre><font size='3'>Created By: " + span_ename.InnerHtml.Trim() + "</font></pre><pre><span style='font-size: medium;'>Please Take Voucher Print By Link Given Below : </span></pre><pre><span style='font-size: medium;'>INTERNET URL:https://" + compname + "/Sudarshan-Portal/Vouchers/Cash_Voucher.aspx?P=" + process_name + "&R=" + req_no + "</span></pre></p><pre></b><pre>INTERNET URL:https://" + compname + "/Sudarshan-Portal/Login.aspx</pre><pre></pre><br/><pre><font size='3'  color='red'><i><b>Kindly attach all the original supporting documents with the voucher print & submit to the Cashier in case mode of payment requested is cash otherwise, send the documents to the Cashier at GHO Pune.</b></i></font></pre>";
                                                                emailid = (string)ActionController.ExecuteAction(txt_Username.Text, "Advance_Request.aspx", "insetmaildata", ref isInserted, txtProcessID.Text, txtInstanceID.Text, 0, "ADVANCE REQUEST APPROVAL", "APPROVE", Init_Email.Text, txtApproverEmail.Text, msg, "Request No: " + spn_req_no.InnerHtml);
                                                            }
                                                            else
                                                            {
                                                                msg = "<pre><font size='3'>Dear Sir/Madam,</font></pre><p/> <pre><font size='3'>Advance Request has been sent to Accounts for payment approval. .!</font></pre><p/> <pre><font size='3'>Request No: " + spn_req_no.InnerHtml + "</font></pre> <pre><font size='3'>Created By: " + span_ename.InnerHtml.Trim() + "</font></pre><pre><span style='font-size: medium;'>Please Take Voucher Print By Link Given Below : </span></pre><pre><span style='font-size: medium;'>INTERNET URL:https://" + compname + "/Sudarshan-Portal/Vouchers/Bank_Voucher.aspx?P=" + process_name + "&R=" + req_no + "</span></pre></p><pre></b><pre>INTERNET URL:https://" + compname + "/Sudarshan-Portal/Login.aspx</pre><pre></pre><br/><pre><font size='3'  color='red'><i><b>Kindly attach all the original supporting documents with the voucher print & submit to the Cashier in case mode of payment requested is cash otherwise, send the documents to the Cashier at GHO Pune.</b></i></font></pre>";
                                                                emailid = (string)ActionController.ExecuteAction(txt_Username.Text, "Advance_Request.aspx", "insetmaildata", ref isInserted, txtProcessID.Text, txtInstanceID.Text, 0, "ADVANCE REQUEST APPROVAL", "APPROVE", Init_Email.Text, txtApproverEmail.Text, msg, "Request No: " + spn_req_no.InnerHtml);
                                                        ...
                                                        {
                                                            Page.RegisterStartupScript("onclick", "<script language='javascript'>{alert('Advance Request has been sent to Accounts for payment approval with deviation.!');window.open('../../Portal/SCIL/Home.aspx','frmset_WorkArea');}</script>");
                                                        }
                                                    }
                                                }
                                            }
                ...
                else if (ddlAction.SelectedItem.Text == "Reject")
                {
                    ...
                    else
                    {
                        string[] Dval = new string[1];
                        Dval[0] = txt_Username.Text;
                        bool isCreate = (bool)WFE.Action.ReleaseStep(txtProcessID.Text, txtInstanceID.Text, "163", "ADVANCE REQUEST APPROVAL", "REJECT", txt_Username.Text, txt_Username.Text.Trim(), "", "", "", "", "", "", "", "", "", "", Dval, txt_Request.Text, txtWIID.Text, ref isInserted);
                        if (isCreate)
                        {
                            try
                            {
                ...
                else if (ddlAction.SelectedItem.Text == "Send-Back")
                {
                    ...
                    else
                    {
                        ...
                        bool isCreate = (bool)WFE.Action.ReleaseStep(txtProcessID.Text, txtInstanceID.Text, "159", "ADVANCE REQUEST APPROVAL", "SEND-BACK", txt_Username.Text, txt_Approver.Text.Trim(), "", "", "", "", "", "", "", "", "", "", Dval, txt_Request.Text, txtWIID.Text, ref isInserted);
                        if (isCreate)
                        {
                            try
                            {

<%@ Page Language="C#" AutoEventWireup="true" ValidateRequest="false" Async="true"
    CodeFile="Advance_Request_ModeChange.aspx.cs" Inherits="Advance_Request_ModeChange" %>
...
<body style="overflow-x: hidden">
                    ...
                    <div class="panel-body" id="div_hdr">
                        <div class="form-horizontal">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-3">
                                    <asp:DropDownList ID="ddl_Payment_Mode" runat="server" class="form-control  input-sm width-xs" onchange="enable_disable()">
                                    </asp:DropDownList>
                                </div>
                                ...
                                <div id="div_payment">
                                    ...
                                    <div class="col-md-3">
                                        <asp:DropDownList ID="ddlAdv_Location" runat="server" class="form-control  input-sm width-xs">
                                        </asp:DropDownList>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="form-horizontal">
                            <div class="form-group">
                                <div class="col-md-8" id="tab_btn3" runat="server" style="text-align: center;">
                                    <asp:Button ID="btnRequest" runat="server" class="btn btn-danger  btn-rounded" Text="Submit" OnClick="btnRequest_Click" />
    ...
    <script type="text/javascript">
        ...
        $("#ddlAdv_Location").change(function () {
            var loc = $("#ddlAdv_Location").val();
            $('#txt_location').val(loc);

        });
        g_serverpath = '/Sudarshan-Portal';
        function downloadfiles(index) {
            window.open(g_serverpath + '/Common/FileDownload.aspx?indentno=' + $("#txt_Request").val() + '&filename=' + $("#uploadTable tr")[index].cells[2].innerText + '&filetag=', 'Download', 'left=150,top=100,width=600,height=300,toolbar=no,menubars=no,status=no,scrollbars=yes,resize=no');
        }
    </script>
</body>
</html>

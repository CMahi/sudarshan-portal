<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Advance_Return_Approval.aspx.cs" Inherits="Advance_Return_Approval" %>
    ...
    <form id="form1" runat="server">
                        ...
                        <div class="form-horizontal">
                            ...
                            <div class="form-group">
                                ...
                                <div id="div15" runat="server">
                                    ...
                                    <div class="col-md-3">
                                        <span id="spn_ret_location" runat="server"></span>
                                    </div>
                                </div>
                                <div class="col-md-1"></div>
                            ...
                            <div class="form-group">
                                ...
                                <div id="div17" runat="server">
                                    <label class="col-md-2">Return Remark</label>
                                    <div class="col-md-5">
                                        <span id="spn_return_remark" runat="server"></span>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="form-horizontal">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-8" id="tab_btn3" runat="server" style="text-align: center;">
                                    <asp:Button ID="btnRequest" runat="server" class="btn btn-danger btn-rounded" Text="Submit" OnClientClick="return popup_data()" OnClick="btnRequest_Click"  />
                                    <asp:Button ID="btnReject" runat="server" class="btn btn-danger btn-rounded" Text="Reject" OnClick="btnReject_Click" />
        ...
        <div style="display: none">
           ...
           <asp:TextBox ID="pre_ins" runat="server" Text="0"></asp:TextBox>
            ...
            <asp:TextBox ID="advtype" runat="server"></asp:TextBox>
            <asp:TextBox ID="return_location_id" runat="server"></asp:TextBox>
        </div>

<%@ Page Language="C#" AutoEventWireup="true" ValidateRequest="false" Async="true"
    CodeFile="Hard_Copy_Document_Modification_Store.aspx.cs" Inherits="Hard_Copy_Document_Modification_Store" %>
...
<body>
                   ...
                   <div class="modal-dialog" style="height: auto; width: 98%; margin-left: 1%">
                        <div class="modal-content" style="background-color: ButtonFace">
                            <div class="modal-header">
                                ...
                                <h4 class="modal-title"><font color="white">Dispatch Note Details</font></h4>
                            </div>
		        ...
		        <div class="col-md-12">
			        <div class="panel panel-danger">
				        <div class="panel-heading">
					        <h3 class="panel-title"><i class="fa fa-fw m-r-10 pull-left f-s-18 fa-user"></i>Store Modification Document Details</h3>
				        </div>
                          ...
                          <div class="form-group">
                            ...
                            <div class="col-md-7">
                             ...
                             <div class="form-group">
			                    ...
			                    <div class="col-md-12" style="text-align:left">
				                <div class="form-group">
			      	                    <h2 class="panel-title">Delivery Challan,LR</h2>
			      	                </div>
			                    </div>
			                </div>
                         </div>
    ...
    <script src="../../JS/Hard_Copy_Document_Modification_Store.js"></script>

...
public partial class Hard_Copy_Document_Approval_Store : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        try
        {
            ...
            {
                AjaxPro.Utility.RegisterTypeForAjax(typeof(Hard_Copy_Document_Approval_Store));
                if (!Page.IsPostBack)
                {
    ...
    protected void btn_SendBack(object sender, System.EventArgs e)
    {
        ...
        else
        {
            try
            {
                ...
                string isSaved = (string)ActionController.ExecuteAction("", "Hard_Copy_Document_Approval_Account.aspx", "updatedoc", ref refData, txt_header.Text, txt_Document_Xml.Text, "STORE");
                if (isSaved != null || isSaved != "false")
                {
                    string[] Dval = new string[1];
                    Dval[0] = txt_Vendor_Code.Text;
                    bool isCreate = (bool)WFE.Action.ReleaseStep(txtProcessID.Text, txtInstanceID.Text, "219", "HARD COPY DOCUMENT APPROVAL STORE", "SEND-BACK", txt_Username.Text, txt_Vendor_Code.Text.Trim(), "", "", "", "", "", "", "", "", "", "", Dval, txt_header.Text, txt_wi.Text, ref isInserted);
                    if (isCreate)
                    {
                        try
                        {
                            string mail = "https://esp.sudarshan.com/Sudarshan-Portal/Login.aspx";
                            string emailid = (string)ActionController.ExecuteAction("", "Hard_Copy_Document_Approval_Account.aspx", "insertmaildata", ref isInserted, txtProcessID.Text, txtInstanceID.Text, 0, "HARD COPY DOCUMENT APPROVAL STORE", "SUBMIT", txt_Vendor_Mail_ID.Text, txt_Email_ID.Text, "<pre><font size='3'>Dear Sir/ Madam,</font></pre><p/><pre><font size='3'>Dispatch note document send back successfully.</font></pre><p/><pre><font size='3'>Unique No: " + txt_Unique_NO.Text + "</font></pre><pre><font size='3'>Dispatch No: <b>" + txt_header.Text + "</font></pre><p/><pre><font size='3'>Vendor Code: " + txt_Vendor_Code.Text.Trim() + "</font></pre></p><pre><font size='3'>Vendor Name: <b>" + txt_Vendor_Name.Text + "</font></pre><p/><pre><font size='3'>PO Number: <b>" + txt_PO_NO.Text + "</font></pre><p/><pre></b><pre><font size='3'>INTERNET URL:<a data-cke-saved-href={" + mail + "} href={" + mail + "}>" + mail + "</a></font></pre></br><pre><font size='3'>Regards</font></pre><pre><font size='3'>Reporting Admin</font></pre><pre><font size='3'  color='red'><i><b>This is a system generated message. We request you not to reply to this message.</b></i></font></pre>", txt_header.Text);
                        }
                        catch (Exception)
                        {
                            throw;
    ...
    public string STORE_RFC_CAll(string Unique_No,string Status)
    {
        ...
        Dispatch_Array = Dispatch_Note.EXCISE_INVOICE_HARD_COPY(Unique_No,Status);

...
public partial class Hard_Copy_Document_Modification_Store : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        try
        {
            ...
            {
                AjaxPro.Utility.RegisterTypeForAjax(typeof(Hard_Copy_Document_Modification_Store));
                if (!Page.IsPostBack)
                {
    ...
    private void GetDocument()
    {
        ...
        DataTable DTS = (DataTable)ActionController.ExecuteAction("", "Hard_Copy_Document_Modification_Store.aspx", "getdocument", ref IsInsert);
    ...
    private void header_data()
    {
        ...
        else
        {
            ...
            DataTable dl = (DataTable)ActionController.ExecuteAction("", "Hard_Copy_Document_Approval_Store.aspx", "getdocumentstore", ref Isdata2, Header_Info);
    ...
    protected void btn_SubmitOnClick(object sender, System.EventArgs e)
    {
        ...
        else
        {
            try
            {
                ...
                DataTable dss = (DataTable)ActionController.ExecuteAction("", "PODispatchDeatails.aspx", "getstore", ref isStore, txt_Plant.Text);
                ...
                if (dss != null)
                {
                    ...
                    {
                        Page.RegisterStartupScript("onclick", "<script language='javascript'>{alert('Plant details not available...!');window.open('../../Portal/SCIL/Home.aspx','frmset_WorkArea');}</script>");
                    }
                }
                else {
                    Page.RegisterStartupScript("onclick", "<script language='javascript'>{alert('Plant details not available...!');window.open('../../Portal/SCIL/Home.aspx','frmset_WorkArea');}</script>");

<%@ Page Language="C#" AutoEventWireup="true" CodeFile="LC_Compliance_Verification.aspx.cs" Inherits="LC_Compliance_Verification" ValidateRequest="false" EnableEventValidation="false" %>
            ...
            <div class="col-lg-12">
                <div class="panel panel-danger">
                    <div class="panel-heading">
                        <h4 class="panel-title"><b>Legal Compliance Verification</b></h4>
                    </div>
                    ...
                    <asp:UpdatePanel ID="updatePanels1" runat="server" UpdateMode="Conditional">
                        <ContentTemplate>
                            <div align="center" style="border: solid 2px Black">
                                <div>
                                    <img alt="Processing" id="img_Progress" src="/Sudarshan-Portal/Img/loading_transparent.gif" />
                                </div>
                                <div>
...
<script type="text/javascript">
    ...
    $("#ddl_Compliance_Name").change(function () {
        if ($("#ddl_Compliance_Name").val() != "0") {
            ...
            $.ajax({
                type: "POST",
                url: "LC_Compliance_Verification.aspx/getdata",

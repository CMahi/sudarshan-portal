<%@ Page Language="C#" AutoEventWireup="true" ValidateRequest="false" Async="true"
    CodeFile="Advance_Request_Approval_Foreign.aspx.cs" Inherits="Advance_Request_Approval_Foreign" %>
...
<body style="overflow-x: hidden">
            ...
            <div class="col-md-12">
                <div class="panel panel-danger">
                    <div class="panel-heading">
                        ...
                        <h3 class="panel-title"><i class="fa fa-fw m-r-10 pull-left f-s-18 fa-user"></i>FOREIGN ADVANCE REQUEST APPROVAL</h3>
              ...
              <div class="col-md-12" id="div_Local">
                <div class="panel panel-grey">
                    ...
                    <div class="panel-body" id="div14">
                        <div class="form-horizontal" id="div_LocalData" runat="server">
    ...
    <script type="text/javascript">
        ...
        function downloadfiles(index) {
            ...
            window.open('../../Common/FileDownload.aspx?enquiryno=' + tbl.rows[index].cells[3].innerText + '&filename=' + tbl.rows[index].cells[2].innerText + '&filetag=', 'Download', 'left=150,top=100,width=600,height=300,toolbar=no,menubars=no,status=no,scrollbars=yes,resize=no');
        }
    </script>
</body>
</html>

<%@ Page Language="C#" AutoEventWireup="true" ValidateRequest="false" Async="true"
    CodeFile="Advance_Request_Modification_Foreign.aspx.cs" Inherits="Advance_Request_Modification_Foreign" %>
...
<div id="divIns" runat="server" style="display:none">
            ...
            <div class="col-md-12">
                <div class="panel panel-danger">
                    <div class="panel-heading">
                        ...
                        <h3 class="panel-title"><i class="fa fa-fw m-r-10 pull-left f-s-18 fa-user"></i>FOREIGN ADVANCE REQUEST MODIFICATION</h3>
                    </div>
            ...
            <div class="col-md-12" id="advance_foreign" runat="server" >
                <div class="panel panel-grey">
                    ...
                    <div class="panel-body">
                        <div class="form-horizontal"  id="div_Forein" runat="server"></div>
                    </div>
                </div>
            </div>
        ...
        <asp:UpdatePanel ID="UpdatePanel2" runat="server">
            <ContentTemplate>
                <div id="div_txt" style="display: none" runat="server">
                    ...
                    <asp:TextBox ID="txt_adv_type_name" runat="server" Text=""></asp:TextBox>
                    ...
                    <asp:TextBox ID="txt_remark_hdr" runat="server"></asp:TextBox>
        ...
        <script src="../../JS/Advance_Request_Modification_Foreign.js"></script>

<%@ Page Language="C#" AutoEventWireup="true" ValidateRequest="false" Async="true"
    CodeFile="Advance_Request_Foreign.aspx.cs" Inherits="Advance_Request_Foreign" EnableEventValidation="false" %>
...
<div id="divIns" runat="server" style="display:none">
                ...
                <div class="panel-body">
                    <div class="form-horizontal">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-3">
                                <asp:DropDownList ID="ddl_city_from" runat="server" class="form-control  input-sm width-xs" onchange="chk_class_From(1)">
                                </asp:DropDownList>
                            ...
                            <div class="col-md-3">
                                <asp:DropDownList ID="ddl_city_to" runat="server" class="form-control  input-sm width-xs" onchange="chk_city_To(1)">
                                </asp:DropDownList>
                                <div id="div_tother">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-3">
                                <asp:DropDownList ID="ddl_currency" runat="server" class="form-control  input-sm width-xs">
                                </asp:DropDownList>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-2" style="text-align: right">
                                <asp:Label ID="lbl_allowedamt" runat="server"></asp:Label>

                            </div>
                            <div class="col-md-1"></div>
                            <label class="col-md-2">Amount(Foreign Currency)</label>
                            <div class="col-md-2" style="text-align: right">
                                <input type='text' style="text-align: right" class="form-control" id="txt_foreign_amt" runat="server" onkeypress="return isNumberKey(event)" onchange="checkamount();" />
                            </div>
                            <div class="col-md-1"></div>
                        </div>
                        <div class="form-group" runat="server" id="div_advance_mode" style="display: none">
                            <div class="col-md-1"></div>
                            <label class="col-md-2">Advance Mode(Currency)</label>
                            <div class="col-md-2" style="text-align: right">
                                <input type='text' style="text-align: right" class="form-control" id="txt_advance_mode_currency" runat="server" onkeypress="return isNumberKey(event)" />

                            </div>
                            <div class="col-md-1"></div>
                            <label class="col-md-2">Advance Mode(Forex Card)</label>
                            <div class="col-md-2" style="text-align: right">
                                <input type='text' style="text-align: right" class="form-control" id="txt_advance_mode_forexcard" runat="server" onkeypress="return isNumberKey(event)" onchange="checkamount1();" />
                            </div>
                            <div class="col-md-1"></div>
                        </div>
                        <div class="form-group">
        ...
        <script src="../../JS/Advance_Request_Foreign.js"></script>

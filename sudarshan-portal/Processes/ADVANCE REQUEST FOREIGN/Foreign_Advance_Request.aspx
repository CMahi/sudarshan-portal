<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Foreign_Advance_Request.aspx.cs" Inherits="Foreign_Advance_Request" EnableEventValidation="false" ValidateRequest="false" %>
...
<body style="overflow-x: hidden">
    <form id="form1" runat="server">
                ...
                <div class="panel-body">
                    <div class="form-horizontal">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-3">
                                <asp:DropDownList ID="ddl_city_to" runat="server" class="form-control  input-sm width-xs" onchange="chk_class_To()">
                                    <asp:ListItem>--Select One--</asp:ListItem>
                                </asp:DropDownList>
                                <div id="div_tother">
                                ...
                                <table class="table table-bordered" id="tbl_Data">
                                    <thead>
                                        <tr class='grey'>
                                            ...
                                            <th style="width: 10%; text-align: center">Requested Currency</th>
                                            <th style="width: 10%; text-align: center">Forex Card</th>
                                            <th style="width: 10%; text-align: center">Cash Mode</th>
                                            <th style="width: 10%; text-align: center">Total</th>
                                            <th style="width: 15%; text-align: center">Equivalent To Base Currency</th>
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td><select id="ddlCurrency1" runat="server" class="form-control input-sm" onchange="change_Currency(1);"></select><span id="spn_inr1" style="display:none">0</span></td>
                                            <td><input type='text' class="form-control input-sm" id="forex1" style="text-align:right" onkeyup="calculate_Total()"  onchange='validateFloatKey(this);' value=""/></td>
                                            <td><input type='text' class="form-control input-sm" id="cash1" style="text-align:right" onkeyup="calculate_Total()" onchange='validateFloatKey(this);' value=""/></td>
                                            <td style="text-align:right"><span id="total_cash1">0</span></td>
                                            <td style="text-align:right"><span id="eq_curr1">0</span></td>
        ...
        <script src="../../JS/Foreign_Advance_Request.js"></script>

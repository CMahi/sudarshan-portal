...
public partial class Foreign_Advance_Request_Approval : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        try
        {
            ...
            {
                AjaxPro.Utility.RegisterTypeForAjax(typeof(Foreign_Advance_Request_Approval));
                if (!Page.IsPostBack)
                {
                                        ...
                                        if (release_id != "")
                                        {
                                            ...
                                            if (isCreate)
                                            {
                                                try
                                                {
                                                    ...
                                                    emailid = (string)ActionController.ExecuteAction(txt_Username.Text, "Foreign_Advance_Request.aspx", "insetmaildata", ref isInserted, txtProcessID.Text, txtInstanceID.Text, 0, "FOREIGN ADVANCE REQUEST APPROVAL", "APPROVE", Init_Email.Text, txtApproverEmail.Text, msg, "Request No: " + spn_req_no.Text);
                                                }
                                                catch (Exception)
                                                {
                                                    throw;
                    ...
                    else
                    {
                        ...
                        if ((txt_Username.Text).ToLower() != (txt_sameapprover.Text).ToLower())  //next same approver
                        {
                            if (dval.Length > 0)
                            {
                                ...
                                {
                                    string ref_data1 = string.Empty;
                                    string release_id = (string)ActionController.ExecuteAction("", "Foreign_Advance_Request.aspx", "getreleaseid", ref ref_data1, txtProcessID.Text, step_name.Text, "DOA-SUBMIT");
                                    if (release_id != "")
                                    {
                                        ...
                                        if (isCreate)
                                        {
                                            try
                                            {
                                                msg = "<pre><font size='3'>Dear Sir/Madam,</font></pre><p/> <pre><font size='3'>Foreign Advance Request Approved Successfully and sent for Deviation Approval.</font></pre><p/> <pre><font size='3'>Request No: " + spn_req_no.Text + "</font></pre> <pre><font size='3'>Created By: " + lbl_EmpName.Text.Trim() + "</font></pre></p><pre></b><pre>INTERNET URL:https://" + compname + "/Sudarshan-Portal/Login.aspx</pre><pre></pre><br/><pre><font size='3'  color='red'><i><b>This is a system generated message. We request you not to reply to this message.</b></i></font></pre>";
                                                emailid = (string)ActionController.ExecuteAction(txt_Username.Text, "Foreign_Advance_Request.aspx", "insetmaildata", ref isInserted, txtProcessID.Text, txtInstanceID.Text, 0, "FOREIGN ADVANCE REQUEST APPROVAL", "DOA-SUBMIT", txtApproverEmail.Text, Init_Email.Text, msg, "Request No: " + spn_req_no.Text);
                                            }
                                            catch (Exception)
                                            {
                                                throw;
                        ...
                        {
                            DTAP = (DataTable)ActionController.ExecuteAction("", "Advance_Request_Approval_Foreign.aspx", "getaccapprover", ref ref_data, "ADVANCE REQUEST FOREIGN ACCOUNT PAYABLE APPROVAL", 0, 2);
                            ...
                            if (DTAP != null)
                            {
                                if (DTAP.Rows.Count > 0)
                                {
                                    ...
                                    else
                                    {
                                        ...
                                        string isSaved1 = (string)ActionController.ExecuteAction("", "Foreign_Advance_Request_Approval.aspx", "updatesameappr", ref ref_data, txtProcessID.Text, txtInstanceID.Text, txt_Audit.Text, txt_Username.Text, spn_Remark.InnerHtml, ddlAction.SelectedItem.Text, txt_Request.Text);

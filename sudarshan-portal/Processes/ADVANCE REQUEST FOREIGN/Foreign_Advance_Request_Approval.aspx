<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Foreign_Advance_Request_Approval.aspx.cs" Inherits="Foreign_Advance_Request_Approval" %>
                ...
                <div class="panel-body">
                    <div class="form-horizontal">
                        ...
                        <asp:Button ID="btn_Save" runat="server" class="btn btn-danger btn-rounded" Text="Submit"
                            OnClientClick="return prepareData();" OnClick="btn_Save_Click" />

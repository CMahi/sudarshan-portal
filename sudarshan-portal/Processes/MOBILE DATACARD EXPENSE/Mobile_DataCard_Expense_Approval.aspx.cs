...
public partial class Mobile_DataCard_Expense_Approval : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        try
        {
            ...
            {
                AjaxPro.Utility.RegisterTypeForAjax(typeof(Mobile_DataCard_Expense_Approval));
                if (!Page.IsPostBack)
                {
   ...
   private void Initialization()
    {
         ...
         DataSet dsData = (DataSet)ActionController.ExecuteAction("", "Mobile_DataCard_Expense_Approval.aspx", "pgetrequestdata", ref IsData1, txtWIID.Text);
           if (dsData != null)
           {
               ...
               doa_support.Text = dsData.Tables[0].Rows[0]["DEV_SUPPORT"].ToString();
           }
         ...
         if (dtUser != null && dtUser.Rows.Count > 0)
         {
             ...
             if (dtApprover != null)
             {
                 if (dtApprover.Rows.Count > 0)
                 {
                     ...
                     if (txt_approvar.Text == span_DApprover.InnerHtml)
                     {
                         txt_sameapp.Text = "1";
                     }
                     else
                 ...
                 {
                     lbl_AppName.Text = doa_user.Text = "NA";
                 }
             }
         }
   ...
   private void ShowMobileUser()
    {
        try
        {
            ...
            if (DTS.Rows.Count > 0)
            {
                ...
                {
                    str.Append("<table id='datatable1'  class='table table-bordered hover'> <thead><tr class='grey'><th>#</th><th>Mobile No</th><th>Service Provider</th><th>Year</th><th>Month</th><th>Bill No</th><th>Bill Date</th><th>Bill Amount</th><th>Rei.Amount</th><th>Limit</th><th>Tax</th><th>Total Reimb.</th><th>Supprting Doc</th><th>Remark</th></tr></thead>");
                }
                else
                {
   ...
   protected void btnRequest_Click(object sender, EventArgs e)
   {
       try
       {
           ...
           else
           {
               ...
               {
                   if (doa_support.Text == "0")
                   {
                       txt_Condition.Text = "3";
                       txt_Audit.Text = "MOBILE DATACARD EXPENSE APPROVAL";
                       ...
                       //{
                       //    DTAP = (DataTable)ActionController.ExecuteAction("", "Mobile_DataCard_Expense_Approval.aspx", "getaccapprover", ref refData, "MOBILE DATACARD DOC VERIFIER", txt_PayLocation.Text, txt_PayMode.Text);
                       //}
                       //else
                       //{
                       //    DTAP = (DataTable)ActionController.ExecuteAction("", "Mobile_DataCard_Expense_Approval.aspx", "getaccapprover", ref refData, "MOBILE DATACARD DOC VERIFIER", 0, txt_PayMode.Text);
                       //}
                       if (lbl_paymentmode.Text.ToUpper() == "CASH")
                       {
                       ...
                       if (DTAP != null)
                       {
                           ...
                           {
                               string isSaved = (string)ActionController.ExecuteAction("", "Mobile_DataCard_Expense_Approval.aspx", "update", ref refData, Convert.ToInt32(txt_Condition.Text), txtProcessID.Text, txtInstanceID.Text, txt_Audit.Text, txt_Initiator.Text, remark, ddl_Action.SelectedItem.Text);
                               ...
                               else
                               {
                                   ...
                                   bool isCreate = (bool)WFE.Action.ReleaseStep(txtProcessID.Text, txtInstanceID.Text, "142", "MOBILE DATACARD EXPENSE APPROVAL", "APPROVE", txt_Username.Text, txt_Username.Text.Trim(), "", "", "", "", "", "", "", "", "", "", Dval, txt_Request.Text, txtWIID.Text, ref isInserted);
                                   if (isCreate)
                                   {
                                       try
                                       {
                                           ...
                                           else
                                           {
                                               if (lbl_paymentmode.Text.ToUpper() == "CASH")
                                               {
                                                   msg = "<pre><font size='3'>Dear Sir/Madam,</font></pre><p/> <pre><font size='3'>Datacard rental expense Request has been sent to accounts for payment approval </font></pre><p/> <pre><font size='3'>Request No: " + txt_Request.Text + "</font></pre> <pre><font size='3'>Created By: " + lbl_EmpName.Text.Trim() + "</font></pre></p><pre></b><pre>INTERNET URL:https://" + compname + "/Sudarshan-Portal/Login.aspx</pre><br/><pre><span style='font-size: medium;'>Please Take Voucher Print By Link Given Below : </span></pre><pre><span style='font-size: medium;'>INTRANET URL:http://espuat/Sudarshan-Portal/Vouchers/Cash_Voucher.aspx?P=" + process_name + "&R=" + req_no + "</span></pre><pre>Regards</pre><pre><b>Reporting Admin<b></pre><br/><pre></pre><br/><pre><font size='3'  color='red'><i><b>This is a system generated message. We request you not to reply to this message.</b></i></font></pre>";
                                                   emailid = (string)ActionController.ExecuteAction(txt_Username.Text, "Mobile_DataCard_Expense_Approval.aspx", "insetmaildata", ref isInserted, txtProcessID.Text, txtInstanceID.Text, 0, "MOBILE DATACARD EXPENSE APPROVAL", "SUBMIT", txtApproverEmail.Text, Init_Email.Text, msg, "Request No: " + txt_Request.Text);
                                               }
                                               else
                                               {
                                       ...
                                       finally
                                       {
                                           if (lbl_expensetype.Text == "Mobile")
                                           {
                                               Page.RegisterStartupScript("onclick", "<script language='javascript'>{alert('Mobile bill rental expense Request has been sent for account payment approval...!');window.open('../../Portal/SCIL/Home.aspx','frmset_WorkArea');}</script>");
                                           }
                                           else
                                           {
                                               Page.RegisterStartupScript("onclick", "<script language='javascript'>{alert('Datacard rental expense Request has been sent for account payment approval...!');window.open('../../Portal/SCIL/Home.aspx','frmset_WorkArea');}</script>");
                           ...
                           {
                               Page.RegisterStartupScript("onclick", "<script language='javascript'>{alert('Account Payment Approver Not Available For " + lbl_paymentmode.Text + " Payment Mode...!');window.open('../../Portal/SCIL/TaskDetails.aspx','frmset_WorkArea');}</script>");
                           }
                       }
                       else
                       {
                   ...
                   else
                   {
                       ...
                       {
                           if (txt_sameapp.Text == "0")
                           {
                               string[] Dval = new string[1];
                               Dval[0] = doa_user.Text;
                               bool isCreate = (bool)WFE.Action.ReleaseStep(txtProcessID.Text, txtInstanceID.Text, "155", "MOBILE DATACARD EXPENSE APPROVAL", "DOA-SUBMIT", txt_Username.Text, txt_Username.Text.Trim(), "", "", "", "", "", "", "", "", "", "", Dval, txt_Request.Text, txtWIID.Text, ref isInserted);
                               if (isCreate)
                               {
                                   try
                                   {
                                       string msg = "<pre><font size='3'>Dear Sir/Madam,</font></pre><p/> <pre><font size='3'>Mobile bill rental Expense Request has been sent for deviation approval.</font></pre><p/> <pre><font size='3'>Request No: " + txt_Request.Text + "</font></pre> <pre><font size='3'>Created By: " + lbl_EmpName.Text.Trim() + "</font></pre></p><pre></b><pre>INTERNET URL:https://" + compname + "/Sudarshan-Portal/Login.aspx</pre><br/><pre>Regards</pre><pre><b>Reporting Admin<b></pre><br/><pre></pre><br/><pre><font size='3'  color='red'><i><b>This is a system generated message. We request you not to reply to this message.</b></i></font></pre>";
                                       string emailid = (string)ActionController.ExecuteAction(txt_Username.Text, "Mobile_DataCard_Expense_Approval.aspx", "insetmaildata", ref isInserted, txtProcessID.Text, txtInstanceID.Text, 0, "MOBILE DATACARD EXPENSE APPROVAL", "DOA-SUBMIT", Init_Email.Text, doa_email.Text, msg, "Request No: " + txt_Request.Text);
                                   }
                                   catch (Exception)
                                   {
                                       throw;
                                   ...
                                   {
                                       Page.RegisterStartupScript("onclick", "<script language='javascript'>{alert('Mobile Bill Request has been sent for deviation approval...!');window.open('../../Portal/SCIL/Home.aspx','frmset_WorkArea');}</script>");
                                   }
                               }
                           }
                           else
                           {
                               txt_Condition.Text = "3";
                               txt_Audit1.Text = "MOBILE DATACARD DEVIATION APPROVAL";
                               DataTable DTAP = new DataTable();
                               string msg = "";
                               string emailid = string.Empty;
                               CryptoGraphy crypt = new CryptoGraphy();
                               ...
                               if (DTAP != null)
                               {
                                   if (DTAP.Rows.Count > 0)
                                   {
                                       string isSaved1 = (string)ActionController.ExecuteAction("", "Mobile_DataCard_Expense_Approval.aspx", "updatetwi", ref refData, Convert.ToInt32(txt_Condition.Text), txtProcessID.Text, txtInstanceID.Text, txt_Audit1.Text, txt_Initiator.Text, remark, ddl_Action.SelectedItem.Text, txt_Request.Text);
                                       if (isSaved1 == null || refData.Length > 0 || isSaved1 == "false")
                                       {
                                           string[] errmsg = refData.Split(':');
                                           Page.RegisterStartupScript("onclick", "<script language='javascript'>{alert('" + errmsg[0].ToString() + "');}</script>");
                                       }
                                       else
                                       {
                                           ...
                                           if (isCreate)
                                           {
                                               try
                                               {
                                                   if (lbl_paymentmode.Text.ToUpper() == "CASH")
                                                   {
                                                       msg = "<pre><font size='3'>Dear Sir/Madam,</font></pre><p/> <pre><font size='3'>Mobile bill rental expense Request has been approved under deviation and sent for Accounts to payment approval</font></pre><p/> <pre><font size='3'>Request No: " + txt_Request.Text + "</font></pre> <pre><font size='3'>Created By: " + lbl_EmpName.Text.Trim() + "</font></pre></p><pre></b><pre>INTERNET URL:https://" + compname + "/Sudarshan-Portal/Login.aspx</pre><br/><pre><span style='font-size: medium;'>Please Take Voucher Print By Link Given Below : </span></pre><pre><span style='font-size: medium;'>INTRANET URL:http://espuat/Sudarshan-Portal/Vouchers/Cash_Voucher.aspx?P=" + process_name + "&R=" + req_no + "</span></pre><pre>Regards</pre><pre><b>Reporting Admin<b></pre><br/><pre></pre><br/><pre><font size='3'  color='red'><i><b>This is a system generated message. We request you not to reply to this message.</b></i></font></pre>";
                                                       emailid = (string)ActionController.ExecuteAction(txt_Username.Text, "Mobile_DataCard_Expense_Approval.aspx", "insetmaildata", ref isInserted, txtProcessID.Text, txtInstanceID.Text, 0, "MOBILE DATACARD EXPENSE APPROVAL", "SUBMIT", txtApproverEmail.Text, Init_Email.Text, msg, "Request No: " + txt_Request.Text);
                                                   }
                                                   else
                                                   {
                                                       msg = "<pre><font size='3'>Dear Sir/Madam,</font></pre><p/> <pre><font size='3'>Mobile bill rental expense Request has been approved under deviation and sent for Accounts to payment approval with deviation</font></pre><p/> <pre><font size='3'>Request No: " + txt_Request.Text + "</font></pre> <pre><font size='3'>Created By: " + lbl_EmpName.Text.Trim() + "</font></pre></p><pre></b><pre>INTERNET URL:https://" + compname + "/Sudarshan-Portal/Login.aspx</pre><br/><pre><span style='font-size: medium;'>Please Take Voucher Print By Link Given Below : </span></pre><pre><span style='font-size: medium;'>INTRANET URL:http://espuat/Sudarshan-Portal/Vouchers/Bank_Voucher.aspx?P=" + process_name + "&R=" + req_no + "</span></pre><pre>Regards</pre><pre><b>Reporting Admin<b></pre><br/><pre></pre><br/><pre><font size='3'  color='red'><i><b>This is a system generated message. We request you not to reply to this message.</b></i></font></pre>";
                                                       emailid = (string)ActionController.ExecuteAction(txt_Username.Text, "Mobile_DataCard_Expense_Approval.aspx", "insetmaildata", ref isInserted, txtProcessID.Text, txtInstanceID.Text, 0, "MOBILE DATACARD EXPENSE APPROVAL", "SUBMIT", txtApproverEmail.Text, Init_Email.Text, msg, "Request No: " + txt_Request.Text);
                                                   }
                                               }
                                               catch (Exception)
                                               ...
                                               {
                                                   Page.RegisterStartupScript("onclick", "<script language='javascript'>{alert('Mobile bill rental expense Request has been approved under deviation and sent for account payment approval...!');window.open('../../Portal/SCIL/Home.aspx','frmset_WorkArea');}</script>");
               ...
               else if (ddl_Action.SelectedItem.Text == "Reject")
               {
                   ...
                   else
                   {
                       string[] Dval = new string[1];
                       Dval[0] = "";
                       bool isCreate = (bool)WFE.Action.ReleaseStep(txtProcessID.Text, txtInstanceID.Text, "145", "MOBILE DATACARD EXPENSE APPROVAL", "REJECT", txt_Username.Text, txt_Username.Text.Trim(), "", "", "", "", "", "", "", "", "", "", Dval, txt_Request.Text, txtWIID.Text, ref isInserted);
                       if (isCreate)
                       {
                           try
                           {
                               if (lbl_expensetype.Text == "Mobile")
                               {
                                   string msg = "<pre><font size='3'>Dear Sir/Madam,</font></pre><p/> <pre><font size='3'>Mobile bill rental Request has been Rejected.</font></pre><p/> <pre><font size='3'>Request No: " + txt_Request.Text + "</font></pre> <pre><font size='3'>Created By: " + lbl_EmpName.Text.Trim() + "</font></pre></p><pre></b><pre>INTERNET URL:https://" + compname + "/Sudarshan-Portal/Login.aspx</pre><br/><pre>Regards</pre><pre><b>Reporting Admin<b></pre><br/><pre></pre><br/><pre><font size='3'  color='red'><i><b>This is a system generated message. We request you not to reply to this message.</b></i></font></pre>";

                                   string emailid = (string)ActionController.ExecuteAction(txt_Username.Text, "Mobile_DataCard_Expense_Approval.aspx", "insetmaildata", ref isInserted, txtProcessID.Text, txtInstanceID.Text, 0, "MOBILE DATACARD EXPENSE APPROVAL", "REJECT", Init_Email.Text, "", msg, "Request No: " + txt_Request.Text);
                               }
                               else
                               {
                                   string msg = "<pre><font size='3'>Dear Sir/Madam,</font></pre><p/> <pre><font size='3'>Datacard rental Request has been Rejected.</font></pre><p/> <pre><font size='3'>Request No: " + txt_Request.Text + "</font></pre> <pre><font size='3'>Created By: " + lbl_EmpName.Text.Trim() + "</font></pre></p><pre></b><pre>INTERNET URL:https://" + compname + "/Sudarshan-Portal/Login.aspx</pre><br/><pre>Regards</pre><pre><b>Reporting Admin<b></pre><br/><pre></pre><br/><pre><font size='3'  color='red'><i><b>This is a system generated message. We request you not to reply to this message.</b></i></font></pre>";
                           ...
                           finally
                           {
                               if (lbl_expensetype.Text == "Mobile")
                               {
                                   Page.RegisterStartupScript("onclick", "<script language='javascript'>{alert('Mobile bill rental Request  has been Rejected..!');window.open('../../Portal/SCIL/TaskDetails.aspx','frmset_WorkArea');}</script>");
                               }
                               else
                               {
                                   Page.RegisterStartupScript("onclick", "<script language='javascript'>{alert('Datacard rental Request  has been Rejected..!');window.open('../../Portal/SCIL/TaskDetails.aspx','frmset_WorkArea');}</script>");
               ...
               else if (ddl_Action.SelectedItem.Text == "Send-Back")
               {
                   ...
                   else
                   {
                       ...
                       bool isCreate = (bool)WFE.Action.ReleaseStep(txtProcessID.Text, txtInstanceID.Text, "143", "MOBILE DATACARD EXPENSE APPROVAL", "SEND-BACK", txt_Username.Text, txt_Username.Text.Trim(), "", "", "", "", "", "", "", "", "", "", Dval, txt_Request.Text, txtWIID.Text, ref isInserted);
                       if (isCreate)
                       {
                           try
                           {
                               if (lbl_expensetype.Text == "Mobile")
                               {
                                   string msg = "<pre><font size='3'>Dear Sir/Madam,</font></pre><p/> <pre><font size='3'>Mobile bill rental Request has been Sent back to Initiator.</font></pre><p/> <pre><font size='3'>Request No: " + txt_Request.Text + "</font></pre> <pre><font size='3'>Created By: " + lbl_EmpName.Text.Trim() + "</font></pre></p><pre></b><pre>INTERNET URL:https://" + compname + "/Sudarshan-Portal/Login.aspx</pre><br/><pre>Regards</pre><pre><b>Reporting Admin<b></pre><br/><pre></pre><br/><pre><font size='3'  color='red'><i><b>This is a system generated message. We request you not to reply to this message.</b></i></font></pre>";

                                   string emailid = (string)ActionController.ExecuteAction(txt_Username.Text, "Mobile_DataCard_Expense_Approval.aspx", "insetmaildata", ref isInserted, txtProcessID.Text, txtInstanceID.Text, 0, "MOBILE DATACARD EXPENSE APPROVAL", "SEND-BACK", Init_Email.Text, txtEmailID.Text, msg, "Request No: " + txt_Request.Text);
                               }
                               else
                               {
                                   string msg = "<pre><font size='3'>Dear Sir/Madam,</font></pre><p/> <pre><font size='3'>Datacard rental Request has been Sent back to Initiator.</font></pre><p/> <pre><font size='3'>Request No: " + txt_Request.Text + "</font></pre> <pre><font size='3'>Created By: " + lbl_EmpName.Text.Trim() + "</font></pre></p><pre></b><pre>INTERNET URL:https://" + compname + "/Sudarshan-Portal/Login.aspx</pre><br/><pre>Regards</pre><pre><b>Reporting Admin<b></pre><br/><pre></pre><br/><pre><font size='3'  color='red'><i><b>This is a system generated message. We request you not to reply to this message.</b></i></font></pre>";
                           ...
                           finally
                           {
                               if (lbl_expensetype.Text == "Mobile")
                               {
                                   Page.RegisterStartupScript("onclick", "<script language='javascript'>{alert('Mobile bill rental Request has been Send back Successfully...!');window.open('../../Portal/SCIL/TaskDetails.aspx','frmset_WorkArea');}</script>");
                               }
                               else
                               {
                                   Page.RegisterStartupScript("onclick", "<script language='javascript'>{alert('Datacard rental Request has been Send back Successfully...!');window.open('../../Portal/SCIL/TaskDetails.aspx','frmset_WorkArea');}</script>");
   ...
   private void fillPolicy_Details()
   {
    ...
    private void fillAction()
    {
        try
        {
            string Isdata = string.Empty;
            ListItem li = new ListItem("--Select One--", "");
            DataTable dt = (DataTable)ActionController.ExecuteAction("", "Mobile_DataCard_Expense_Approval.aspx", "action", ref Isdata);
            if (dt != null && dt.Rows.Count > 0)
            {

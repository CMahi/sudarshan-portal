<%@ Page Language="C#" AutoEventWireup="true" ValidateRequest="false" Async="true"
    CodeFile="Acccount_Payable_Approval.aspx.cs" Inherits="Acccount_Payable_Approval" %>
...
<head id="Head1" runat="server">
    <title>Account Payable Approval</title>
...
<body style="overflow-x: hidden">
	...
	<div class="col-md-12">
			<div class="panel panel-danger">
				<div class="panel-heading">
					...
					<h3 class="panel-title"><i class="fa fa-fw m-r-10 pull-left f-s-18 fa-user"></i>MOBILE DATACARD ACCOUNT PAYABLE APPROVAL</h3>
				</div>
  ...
  <script type="text/javascript">
      ...
      function hide_show_remark() {
          $("#txtRemark").val("");
          if ($("#ddl_Action option:selected").index() < 1) {
              $("#div_remark").hide();
              $("#lbl_rmk").hide();
          }
          else {

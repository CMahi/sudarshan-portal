...
public partial class Mobile_DataCard_Expense_ModeChnage : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        try
        {
            ...
            {
                AjaxPro.Utility.RegisterTypeForAjax(typeof(Mobile_DataCard_Expense_ModeChnage));
                if (!Page.IsPostBack)
                {
   ...
   private void Initialization()
    {
         ...
         if (DTS != null && DTS.Rows.Count > 0)
         {
             ...
             if (lbl_expensetype.Text=="DataCard")
             {
                 ...
                 ddlPayMode.Items.FindByValue(DTS.Rows[0]["PAYMENT_MODE1"].ToString()).Selected = true;
                 if (DTS.Rows[0]["PAYMENT_MODE1"].ToString() != "2")
                 {
                     ddlLocation.Items.FindByValue(DTS.Rows[0]["LOCATION"].ToString()).Selected = true;
                 }
       ...
       try
       {
           ...
           else
           {
               ...
               string ISValid = string.Empty;
                       ...
                       txt_Condition.Text = "0";
                       txt_Audit.Text = "MOBILE DATACARD PAYMENT MODE CHANGE";
                       ...
                       if (DTAP != null)
                       {
                           ...
                           {
                               string isSaved = (string)ActionController.ExecuteAction("", "Mobile_DataCard_Expense_Approval.aspx", "update", ref refData, Convert.ToInt32(txt_Condition.Text), txtProcessID.Text, txtInstanceID.Text, txt_Audit.Text, txt_Initiator.Text, "", "Submit");
                               string isChange = (string)ActionController.ExecuteAction("", "Mobile_DataCard_Expense_Approval.aspx", "updatemode", ref refData, ddlLocation.SelectedValue, ddlPayMode.SelectedValue, txt_pk_id.Text);
                               ...
                               else
                               {
                                   ...
                                   bool isCreate = (bool)WFE.Action.ReleaseStep(txtProcessID.Text, txtInstanceID.Text, "208", "MOBILE DATACARD PAYMENT MODE CHANGE", "SUBMIT", txt_Username.Text, txt_Username.Text.Trim(), "", "", "", "", "", "", "", "", "", "", Dval, txt_Request.Text, txtWIID.Text, ref isInserted);
                                   if (isCreate)
                                   {
                                       try
                                       {
                                           ...
                                           {
                                               string msg = "<pre><font size='3'>Dear Sir/Madam,</font></pre><p/> <pre><font size='3'>Mobile bill rental Expense Request has been sent account payment approval</font></pre><p/> <pre><font size='3'>Request No: " + txt_Request.Text + "</font></pre> <pre><font size='3'>Created By: " + lbl_EmpName.Text.Trim() + "</font></pre></p><pre></b><pre>INTERNET URL:https://" + compname + "/Sudarshan-Portal/Login.aspx</pre><br/><pre>Regards</pre><pre><b>Reporting Admin<b></pre><br/><pre></pre><br/><pre><font size='3'  color='red'><i><b>This is a system generated message. We request you not to reply to this message.</b></i></font></pre>";

                                               string emailid = (string)ActionController.ExecuteAction(txt_Username.Text, "Mobile_DataCard_Expense_Approval.aspx", "insetmaildata", ref isInserted, txtProcessID.Text, txtInstanceID.Text, 0, "MOBILE DATACARD PAYMENT MODE CHANGE", "SUBMIT", txtApproverEmail.Text, Init_Email.Text, msg, "Request No: " + txt_Request.Text);
                                           }
                                           else
                                           {
                                               string msg = "<pre><font size='3'>Dear Sir/Madam,</font></pre><p/> <pre><font size='3'>Datacard rental Expense Request has been sent account payment approval</font></pre><p/> <pre><font size='3'>Request No: " + txt_Request.Text + "</font></pre> <pre><font size='3'>Created By: " + lbl_EmpName.Text.Trim() + "</font></pre></p><pre></b><pre>INTERNET URL:https://" + compname + "/Sudarshan-Portal/Login.aspx</pre><br/><pre>Regards</pre><pre><b>Reporting Admin<b></pre><br/><pre></pre><br/><pre><font size='3'  color='red'><i><b>This is a system generated message. We request you not to reply to this message.</b></i></font></pre>";
                           ...
                           {
                               Page.RegisterStartupScript("onclick", "<script language='javascript'>{alert('Account Payment Approver Not Available For " + ddlPayMode.SelectedItem.Text + " Payment Mode...!');window.open('../../Portal/SCIL/TaskDetails.aspx','frmset_WorkArea');}</script>");
                           }
                       }
                       else
                       {

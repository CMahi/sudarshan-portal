<%@ Page Language="C#" AutoEventWireup="true" ValidateRequest="false" Async="true"
    CodeFile="Doc_Verification_Approval.aspx.cs" Inherits="Doc_Verification_Approval" %>
...
<head runat="server">
    <title>Doc Verification Approval</title>
                ...
                <div class="modal-content">
                    ...
                    <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-3">
                                    <asp:Label ID="lbl_GLCode" runat="server"></asp:Label>
                                </div>
                            </div>
                            <div class="form-group">
                                <div class="col-md-1"></div>
	...
	<div class="col-md-12">
			<div class="panel panel-danger">
				<div class="panel-heading">
					...
					<h3 class="panel-title"><i class="fa fa-fw m-r-10 pull-left f-s-18 fa-user"></i>MOBILE DATACARD DOCUMENT VERIFICATION</h3>
				</div>
       	...
       	<div class="col-md-12" id="div_UserMobileA">
			<div class="panel panel-grey">
					...
					<div class="form-group">
							...
							<div class="col-md-2">
								<asp:label id="lbl_dedyear" runat="server"></asp:label>
							</div>
							<label class="col-md-2">Deduction Month :-</label>
							<div class="col-md-2">
								<asp:label id="lbl_dedmonth" runat="server"></asp:label>
							</div>
							
                        	<label class="col-md-2">Deduction Amount :-</label>
							<div class="col-md-2">
								<asp:label id="lbl_dedamount" runat="server"></asp:label>
							</div>
				...
				<div class="panel-body" id="div3">
					<%--<div class="panel pagination-danger">--%>
						<div class="table-responsive" style="width: 100%" id="div_userMobile" runat="server">
                    <%---</div>--%>
				</div>
			</div>

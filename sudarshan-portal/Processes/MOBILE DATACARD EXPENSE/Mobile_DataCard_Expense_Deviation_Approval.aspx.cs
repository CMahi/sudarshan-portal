...
public partial class Mobile_DataCard_Expense_Deviation_Approval : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        try
        {
            ...
            {
                AjaxPro.Utility.RegisterTypeForAjax(typeof(Mobile_DataCard_Expense_Deviation_Approval));
                if (!Page.IsPostBack)
                {
       ...
       try
       {
           ...
           else
           {
               ...
               if (ddl_Action.SelectedItem.Text == "Approve")
               {
                   ...
                   txt_Audit.Text = "MOBILE DATACARD DEVIATION APPROVAL";
                   string msg = "";
                   ...
                   if (DTAP != null)
                   {
                       if (DTAP.Rows.Count > 0)
                       {
                           ...
                           else
                           {
                               ...
                               bool isCreate = (bool)WFE.Action.ReleaseStep(txtProcessID.Text, txtInstanceID.Text, "154", "MOBILE DATACARD DEVIATION APPROVAL", "SUBMIT", txt_Username.Text, txt_Username.Text.Trim(), "", "", "", "", "", "", "", "", "", "", Dval, txt_Request.Text, txtWIID.Text, ref isInserted);
                               if (isCreate)
                               {
                                   try
                                   {
                                       if (lbl_paymentmode.Text.ToUpper() == "CASH")
                                        {
                                            ...
                                            emailid = (string)ActionController.ExecuteAction(txt_Username.Text, "Mobile_DataCard_Expense_Approval.aspx", "insetmaildata", ref isInserted, txtProcessID.Text, txtInstanceID.Text, 0, "MOBILE DATACARD DEVIATION APPROVAL", "SUBMIT", txtApproverEmail.Text, Init_Email.Text, msg, "Request No: " + txt_Request.Text);
                                        }
                                        else
                                        {
                       ...
                       {
                           Page.RegisterStartupScript("onclick", "<script language='javascript'>{alert('Account Payment Approval Not Available For " + lbl_paymentmode.Text + " Payment Mode...!');window.open('../../Portal/SCIL/TaskDetails.aspx','frmset_WorkArea');}</script>");
                       }
                   }
                   else
                   {
               ...
               else if (ddl_Action.SelectedItem.Text == "Reject")
               {
                   ...
                   else
                   {
                       ...
                       Dval[0] = "";
                       bool isCreate = (bool)WFE.Action.ReleaseStep(txtProcessID.Text, txtInstanceID.Text, "152", "MOBILE DATACARD DEVIATION APPROVAL", "REJECT", txt_Username.Text, txt_Username.Text.Trim(), "", "", "", "", "", "", "", "", "", "", Dval, txt_Request.Text, txtWIID.Text, ref isInserted);
                       if (isCreate)
                       {
                           try
                           {
                               ...
                               string emailid = (string)ActionController.ExecuteAction(txt_Username.Text, "Mobile_DataCard_Expense_Approval.aspx", "insetmaildata", ref isInserted, txtProcessID.Text, txtInstanceID.Text, 0, "MOBILE DATACARD DEVIATION APPROVAL", "REJECT", Init_Email.Text, "", msg, "Request No: " + txt_Request.Text);
                           }
                           catch (Exception)
                           {
                               throw;
               ...
               else if (ddl_Action.SelectedItem.Text == "Send-Back")
               {
                   ...
                   else
                   {
                       ...
                       bool isCreate = (bool)WFE.Action.ReleaseStep(txtProcessID.Text, txtInstanceID.Text, "153", "MOBILE DATACARD DEVIATION APPROVAL", "SEND-BACK", txt_Username.Text, txt_Username.Text.Trim(), "", "", "", "", "", "", "", "", "", "", Dval, txt_Request.Text, txtWIID.Text, ref isInserted);
                       if (isCreate)
                       {
                           try
                           {
                               ...
                               string emailid = (string)ActionController.ExecuteAction(txt_Username.Text, "Mobile_DataCard_Expense_Approval.aspx", "insetmaildata", ref isInserted, txtProcessID.Text, txtInstanceID.Text, 0, "MOBILE DATACARD DEVIATION APPROVAL", "SEND-BACK", Init_Email.Text, txtEmailID.Text, msg, "Request No: " + txt_Request.Text);
                           }
                           catch (Exception)
                           {
                               throw;

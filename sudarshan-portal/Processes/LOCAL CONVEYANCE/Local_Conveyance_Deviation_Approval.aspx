<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Local_Conveyance_Deviation_Approval.aspx.cs" Inherits="Local_Conveyance_Deviation_Approval" EnableEventValidation="false" ValidateRequest="false"%>
                ...
                <div class="modal-content">
                 ...
                 <div class="form-horizontal">
                    <div class="form-group">
                            ...
                            <div class="form-group">
                               <div class="col-md-1"></div>
                                <label class="col-md-2">GL Code</label>
                                <div class="col-md-3">
                                    <div id="GLCode"><span id="span_glcode" runat="server"></span></div>
                                </div>
            ...
            <div class="col-md-12">
                <div class="panel panel-danger">
                    <div class="panel-heading">
                          <div class="panel-heading-btn">
                            <a href="#div_user_data" data-toggle="modal" title="Requestor's Detail" style="color:blue"><i class="fa fa-fw m-r-10 pull-left f-s-18 fa-user"></i></a>
                                     ...
                                     <h3 class="panel-title"><i class="fa fa-fw m-r-10 pull-left f-s-18 fa-user"></i>LOCAL CONVEYANCE DEVIATION APPROVAL</h3>
                    ...
                    <div class="panel-body" id="div_hdr">
                             ...
                             <div class="col-md-2">
                                  <b><asp:DropDownList ID="ddl_Payment_Mode" runat="server" class="form-control input-sm" Enabled="false">
                                    </asp:DropDownList></b>                               
                                </div>
                                    <div class="col-md-1"></div>
                                <label class="col-md-2">Payment Location</label>
                                <div class="col-md-2">
                                  <b><asp:DropDownList ID="ddlAdv_Location" runat="server" class="form-control input-sm" Enabled="false">
                                    </asp:DropDownList></b>                               
                                </div>
                            </div>
                                <div class="form-group">
                             ...
                             <div class="col-md-2">
                                      <div id="Remark"><b><textarea id="txt_tremark" class="form-control" rows="1"  maxlength="200" runat="server" Enabled="false"></textarea></b></div>                      
                                </div>

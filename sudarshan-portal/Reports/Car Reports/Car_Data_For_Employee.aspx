<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Car_Data_For_Employee.aspx.cs" Inherits="Car_Data_For_Employee" %>
...
<body>
    <form id="form1" runat="server">
            ...
            <div class="col-lg-12">
                <div class="panel panel-danger">
                    <div class="panel-heading">
                        ...
                        <h4 class="panel-title">YEAR END PROCESSING BY EMPLOYEE REPORT</h4>
                    </div>
                    <div class="panel-body">
                        <div class="panel pagination-danger">
                            <div class="row">
                                <div class="col-md-2">
                                    <b><span id="Span2" runat="server">Employee code : </span></b>
                                    <b><span id="span_code" runat="server"></span></b>
                                </div>

                                <div class="col-md-3">
                                    <b><span id="Span4" runat="server">Employee name : </span></b>
                                    <b><span id="span_name" runat="server"></span></b>
                                </div>
                                <br />
                                <br />

                                <label class="col-md-2"><b>Car Expense Heads</b></label>
                                <div class="col-md-2">
                                    <asp:DropDownList ID="ddl_Exp_Head" runat="server" class="form-control">
                                        ...
                                        <asp:ListItem Value='Driver'>Driver Expense</asp:ListItem>
                                ...
                                <br />
                                <%-- <div class="col-md-4">
                                    <b><span id="span" runat="server">Eligibility in litters for current financial year : </span></b>
                                    <b><span id="span_eligible" runat="server">0</span></b>
                                </div>
                             <div class="col-md-3">
                                    <b><span id="span6" runat="server">Claimed so far during this financial year : </span></b>
                                    <b><span id="span_claimed" runat="server">0</span></b>
                                </div>
                                 <div class="col-md-3">
                                    <b><span id="span7" runat="server">Balance : </span></b>
                                    <b><span id="span_bal" runat="server">0</span></b>
                                </div>
                                 <br />   <br />
                                 <div class="col-md-2">
                                         </div>--%>
                               ...
                               <div class="col-md-3" style="display: none">
                                    <b><span id="Span3" runat="server">Total Cumulative Amount : </span></b>
                                    <b><span id="span_cumu" runat="server">0</span></b>
                                </div>
                                <div class="col-md-2">
                            ...
                            <div class="table-responsive" id="divyear" runat="server">
                            </div>
        ...
        <div id="conditionButton" style="display: none">
            ...
            <asp:TextBox ID="txt_cumuamt" runat="server"></asp:TextBox>
    ...
    <script>
        function check() {
            ...
            var type = $('#ddl_Exp_Head').val();
            if (type == 0) {
                alert("Select Car Expense Head");
                return false;
            }
            $("#divIns").show();
            return true;
        ...
        $('body').on('click', '.reqno', function () {
            ...
            var p_name = data[3];
            var requ_no = data[2];
            Car_Data_For_Employee.getDetails(requ_no, p_name, callback_BindRequestData);
        })
        ...
        function getRequestDetails(index) {
            ...
            Car_Data_For_Employee.getDetails(req_no, process_name, callback_BindRequestData);
        }

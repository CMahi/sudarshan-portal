<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Advance_Report_Dtl.aspx.cs" Inherits="Advance_Report_Dtl" %>
...
<head runat="server">
    <meta charset="utf-8" />
    <title>Advance Report Details</title>
            ...
            <div class="col-md-12">
                <div class="panel panel-danger">
                    <div class="panel-heading">
                        ...
                        <h3 class="panel-title">Advance Report Details</h3>
                    </div>
                </div>
            </div>
            <div class="col-md-12" style="margin-top: -8px;">
                <div class="panel panel-grey">
                    <div class="panel-heading">
                        ...
                        <h4 class="panel-title">Advance Report Details</h4>
                    </div>
                    <div class="panel-body">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                ...
                                <asp:Button ID="btnExport" runat="server" CssClass="btn btn-sm btn-danger" Text="Export"  OnClick="btnExport_Click" />
                        ...
                        <hr />
                        <div style="overflow: visible; margin-top: 20px;display:block">

...
public partial class Foreign_Chargable_Report : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        try
        {
            ...
            AjaxPro.Utility.RegisterTypeForAjax(typeof(Foreign_Chargable_Report));
    ...
    protected void getExpenseData(int charge)
    {
		...
		divIns.Style.Add("display","none");
                ...
                if (dt.Rows.Count > 0)
                {
                    str.Append("<table id='data-table1' class='table table-bordered table-hover' ><thead><tr class='grey'><th> #</th><th>Employee Code</th><th>Employee Name</th><th>Request_No</th><th>Area Visited</th><th>Currency</th>");
    ...
    protected void btn_Export_onClick(object sender, EventArgs e)
    {
        ...
        else
        {
            ...
            ExportToExcel(data, "FOREIGN TRAVEL CHARGABLE REPORT");
        }
    }

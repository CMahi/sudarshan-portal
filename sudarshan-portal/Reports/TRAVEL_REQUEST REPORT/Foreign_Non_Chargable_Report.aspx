<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Foreign_Non_Chargable_Report.aspx.cs" Inherits="Foreign_Non_Chargable_Report" %>
...
<head>
    <meta charset="utf-8" />
    <title>Foreign Travel Non-Chargable Expense Report</title>
...
<div id="divIns" runat="server" style="display:none">
            ...
            <div class="col-lg-12">
                <div class="panel panel-danger">
                    <div class="panel-heading">
                        ...
                        <h4 class="panel-title">Foreign Non-Chargable Expense Report</h4>
                    </div>
        ...
        <script>
            ...
            function view_details(wiid) {
                Foreign_Non_Chargable_Report.getRequestDetails(wiid, callBack_Data);
            }

<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Foreign_Travel_Expense_Report.aspx.cs" Inherits="Foreign_Travel_Expense_Report" EnableEventValidation="false" ValidateRequest="false" %>
...
<div id="divIns" runat="server" style="display:none">
            ...
            <div class="col-lg-12">
                <div class="panel panel-danger">
                    <div class="panel-heading">
                             <h4 class="panel-title">Foreign Travel Expense Report</h4>
                    </div>
        ...
        <script>
            ...
            {
                Foreign_Travel_Expense_Report.getRequestDetails(wiid,callBack_Data);
            }
            ...
            function getData()
            {
                try {
                    ...
                    Foreign_Travel_Expense_Report.getExpenseData(status, callBackSuccess);
                }
                catch (ex) {
                    $("#divIns").hide();
                }

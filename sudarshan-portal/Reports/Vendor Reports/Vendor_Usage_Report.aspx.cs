...
public partial class Vendor_Usage_Report : System.Web.UI.Page
{
    ...
    protected void btnsubmit_Click(object sender, EventArgs e)
    {
        ...
        else
        {
            try
            {
                ...
                str.Append("<table id='data-table1'  class='table table-bordered table-hover'> <thead><tr class='grey'><th>Date</th><th>Acknowledged POs</th><th>Dispatched POs</th><th>No. of Logged Vendors</th></tr>");   
                ...
                {                   
                    ...
                    if (isSaved != "")
                    {
                        ...
                        str.Append("<td class='logindata'><a href='#login' data-toggle='modal'>" + Request_Unique[3] + "</a></td></tr>");
                     }                   
                ...
                str1.Append("<table id='data-table2'  class='table table-bordered table-hover'> <thead><tr class='grey'><th>Not Logged Vendors</th></tr>");
                str1.Append("</thead><tbody>");
                string isSaved1 = (string)ActionController.ExecuteAction("", "Vendor_Usage_Report.aspx", "notlogindata", ref isValid1);
                    if (isSaved1 != "")
                    {
                        str1.Append("<tr>");
                        str1.Append("<td class='nlogin'><a href='#nlogin' data-toggle='modal'>" + isSaved1.ToString() + "</a></td>");       
                        str1.Append("</tr>");   
                    }
               
                str1.Append("</tbody></table> ");
                div_vendor.InnerHtml = str1.ToString();
                //ScriptManager.RegisterStartupScript(this, GetType(), "", "$('#data-table2').dataTable();", true);
                //////////loging vendors/////////////////////////
                StringBuilder str2 = new StringBuilder();
                div_vendor1.InnerHtml = null;
                string isValid2 = string.Empty;
                str2.Append("<table id='data-table3'  class='table table-bordered table-hover'> <thead><tr class='grey'><th>Logged Vendors</th></tr>");
                str2.Append("</thead><tbody>");
                string isSaved2 = (string)ActionController.ExecuteAction("", "Vendor_Usage_Report.aspx", "logindata", ref isValid2);
                if (isSaved2 != "")
                {
                    str2.Append("<tr>");
                    str2.Append("<td class='loginn'><a href='#loginn' data-toggle='modal'>" + isSaved2.ToString() + "</a></td>");
                    str2.Append("</tr>");
                }
                str2.Append("</tbody></table> ");
                div_vendor1.InnerHtml = str2.ToString();
            }
            catch (Exception ex)
            {
    ...
    protected void btn_export_nlogin_onClick(object sender, EventArgs e)
    {
        ...
        {
            ExportToExcelNLogin(div_nlogin.InnerText, "Vendor Details");
        }
    }
    ...
    protected void btn_export_dispatch_onClick(object sender, EventArgs e)
    {
        ...
        {
            ExportToExcelDis(div_dispatch.InnerText, "Dispatch PO's Details");
        }
    }
    ...
    protected void btn_export_loginn_onClick(object sender, EventArgs e)
    {
        if (ActionController.IsSessionExpired(Page))
            ActionController.RedirctToLogin(Page);
        else
        {
            ExportToExcelLoginDetail(div_loginn.InnerText, "Login Details");
        }
    }
    [AjaxPro.AjaxMethod(HttpSessionStateRequirement.ReadWrite)]
    ...
    protected void ExportToExcelAck(string divack, string filename)
    {
        try
        {
            ...
            if (divack != "")
            {
                Response.Write("<table border=\"1\"><tr><td colspan='8' align='center' style=\"font-weight:bold;font-size:'20';\">Acknowleged PO's Details</td></tr>");
    ...
    protected void ExportToExcelDis(string divack, string filename)
    {
        try
        {
            ...
            if (divack != "")
            {
                Response.Write("<table border=\"1\"><tr><td colspan='8' align='center' style=\"font-weight:bold;font-size:'20';\">Dispatched PO's Details</td></tr>");
                Response.Write("<tr style=\"font-weight:bold\"><td colspan='8'></td></tr>");
                Response.Write("<tr style=\"font-weight:bold\"><td colspan='7' align='center'>" + divack + "</td></tr>");
                Response.Write("</table>");
    ...
    protected void ExportToExcelLoginDetail(string divack, string filename)
    {
        try
        {
            string dt = string.Empty;
            ...
            Response.AddHeader("content-disposition", attachment);
            Response.ContentType = "application/ms-excel";
            divack = txt_exp_loginn_data.Text;
            if (divack != "")
            {
                Response.Write("<table border=\"1\"><tr><td colspan='8' align='center' style=\"font-weight:bold;font-size:'20';\">Login Details</td></tr>");
                Response.Write("<tr style=\"font-weight:bold\"><td colspan='8'></td></tr>");
    ...
    protected void ExportToExcelNLogin(string divack, string filename)
    {
        try
        {
            string dt = string.Empty;
            ...
            Response.AddHeader("content-disposition", attachment);
            Response.ContentType = "application/ms-excel";
            divack = txt_exp_nlogin_data.Text;
            if (divack != "")
            {
                Response.Write("<table border=\"1\"><tr><td colspan='8' align='center' style=\"font-weight:bold;font-size:'20';\">Login Details</td></tr>");
                Response.Write("<tr style=\"font-weight:bold\"><td colspan='8'></td></tr>");
    ...
    protected void ExportToExcel(StringBuilder dgview, string filename)
    {
        try
        {
            ...
            string[] strdate = new string[diff];
            strdate[0] = txt_f_date.Value;
            str.Append("<table ><tr class='grey'><td>Date</td><td>Acknowledged POs</td><td>Dispatched POs</td><td>No. of Logged Vendors</td></tr>");
            //str.Append("</thead><tbody>");
            ...
            for (int i = 0; i < diff; i++)
            {
                ...
                if (isSaved != "")
                {
                    ...
                    str.Append("<td >" + Request_Unique[3] + "</td></tr>");
                }
    ...
    protected void btnClear_Click(object sender, EventArgs e)
    {
        ...
        txt_t_date.Value = "";
        div_po.InnerHtml = "";
        div_vendor.InnerHtml = "";
        div_acknow.InnerHtml = "";
        div_dispatch.InnerHtml = "";
        div_login.InnerHtml = "";

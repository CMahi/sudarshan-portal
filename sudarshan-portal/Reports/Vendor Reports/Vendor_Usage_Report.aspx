...
<body style="overflow-x: hidden">
    <form id="frm_report" runat="server">
                ...
                <div class="panel-body">
                    <div class="form-horizontal">
                        ...
                        <div class="form-group">
                            <div class="col-md-2"></div>
                            <div class="col-md-8">
                                <div id="div_vendor" runat="server" ></div>
                            </div>
                        </div>
                               <div class="form-group">
                            <div class="col-md-2"></div>
                            <div class="col-md-8">
                                <div id="div_vendor1" runat="server" ></div>
                            </div>
                        </div>
                                 <div class="form-group">
                            <div class="col-md-2"></div>
                            <div class="col-md-8">
                                <div id="div_" runat="server" ></div>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <div class="modal fade" id="loginn">
            <div class="modal-dialog">
                <div class="modal-content" style="background-color: ButtonFace">
                    ...
                    <asp:Button ID="btn_export_loginn" align="left" runat="server" Text="Export" class="btn btn-sm btn-inverse" OnClick="btn_export_loginn_onClick" />

                    <div  id="div_loginn" runat="server" data-scrollbar="true" data-height="425px">
                    </div>
        ...
        <div id="conditionButton" style="display: none">
            ...
            <asp:TextBox ID="txt_exp_loginn_data" runat="server" Width="1px"></asp:TextBox>
    ...
    <script language="javascript" type="text/javascript">
        ...
        $('body').on('click', '.nlogin', function () {
            var table = $('#data-table2').DataTable();
            var data = table.row($(this).parents('tr')).data();
            Vendor_Usage_Report.bindReport("", 4, nlogin_details);
        });
        $('body').on('click', '.loginn', function () {
            var table = $('#data-table3').DataTable();
            var data = table.row($(this).parents('tr')).data();
            Vendor_Usage_Report.bindReport("", 5, loginn_details);
        });
        ...
        function nlogin_details(response) {            
            $("#div_nlogin").html(response.value);
            $("#txt_exp_nlogin_data").val(response.value);
        }
        function loginn_details(response) {
            $("#div_loginn").html(response.value);
            $("#txt_exp_loginn_data").val(response.value);
        }
    </script>

<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Material_Transit_Report.aspx.cs" Inherits="Material_Transit_Report" %>
...
<head id="Head1" runat="server">
    <meta charset="utf-8" />
    <title>Material Transit Report</title>
            ...
            <div class="modal-dialog" style="height: auto; width: 98%; margin-left: 1%">
                <div class="modal-content" style="background-color: ButtonFace">
                    <div class="modal-header">
                        ...
                        <h4 class="modal-title"><font color="white"> Material Transit Report</font></h4>
                    </div>
...
<div class="btn-group pull-right" style="margin-top:-5px;">
                        ...
                        <h3 class="panel-title">Material Transit Report</h3>
                    </div>
                </div>
            </div>
            <div class="col-md-12" style="margin-top: -8px;">
                <div class="panel panel-grey">
                    <div class="panel-heading">
                        ...
                        <h4 class="panel-title">Material Transit Report</h4>
                    </div>
                    <div class="panel-body">
                        ...
                        <div class="table-responsive" id="div_ReportDetails" runat="server" style="overflow: auto">
                        </div>
                    </div>
                </div>
            </div>
        ...
        <script src="../../JS/Material_Transit_Report.js"></script>

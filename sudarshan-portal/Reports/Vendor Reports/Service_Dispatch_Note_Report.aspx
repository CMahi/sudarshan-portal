<%@ Page ValidateRequest="false" EnableEventValidation="false" AutoEventWireup="true" Language="C#" Async="true" CodeFile="Service_Dispatch_Note_Report.aspx.cs" Inherits="Service_Dispatch_Note_Report" %>
...
<head runat="server">
    <meta charset="utf-8" />
    <title>Service Dispatch Note Report</title>
...
<body>
    <form id="form1" runat="server">
            ...
            <div class="modal-dialog" style="height: auto; width: 98%; margin-left: 1%">
                <div class="modal-content" style="background-color: ButtonFace">
                    <div class="modal-header">
                        ...
                        <h4 class="modal-title"><font color="white">Service Dispatch Request Details </font></h4>
                    </div>
            ...
            <div class="col-md-12">
                <div class="panel panel-danger">
                    <div class="panel-heading">
                        ...
                        <h3 class="panel-title">Service Dispatch Note Report</h3>
                    </div>
                </div>
            </div>
            <div class="col-md-12" style="margin-top: -8px;">
                <div class="panel panel-grey">
                    <div class="panel-heading">
                        ...
                        <h4 class="panel-title">Service Dispatch Note Details</h4>
                    </div>
                        ...
                        <div class="form-horizontal">
                            <div class='form-group'>
                                ...
                                <div class="col-md-2">
                                    ...
                                    <%--OnSelectedIndexChanged="selectedpo" AutoPostBack="true"--%>
                                </div>
                            ...
                            <div class="text-center">
                                <asp:UpdatePanel ID="update" runat="server">
                                    <ContentTemplate>
                                        <asp:Button ID="btn_Submit" runat="server" class="btn btn-danger btn-rounded m-b-3" Text="Submit" OnClick="btn_SubmitData" OnClientClick="return check()" />
                                        <asp:Button ID="btn_Clear" runat="server" class="btn btn-danger btn-rounded m-b-3" Text="Clear" OnClientClick="return Clear()" />
        ...
        <script src="../../JS/Service_Dispatch_Note_Report.js"></script>

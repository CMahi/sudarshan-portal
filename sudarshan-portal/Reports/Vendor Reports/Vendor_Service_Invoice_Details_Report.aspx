<%@ Page Language="C#" AutoEventWireup="true" ValidateRequest="false" CodeFile="Vendor_Service_Invoice_Details_Report.aspx.cs" Inherits="Vendor_Service_Invoice_Details_Report" %>
...
<head runat="server">
    <meta charset="utf-8" />
    <title>Service Invoice Details Report</title>
    ...
    <form id="form1" runat="server">
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="panel panel-danger">
                    <div class="panel-heading">
                        ...
                        <h3 class="panel-title"><b>Service Invoice Details Report</b></h3>
                    </div>
                </div>
            </div>
                ...
                <div class="panel panel-grey">
                    <div class="panel-heading">
                        <div class="panel-heading">
                            ...
                            <h4 class="panel-title">Service Invoice Details</h4>
                        </div>
                    </div>
                    <div class="panel panel-body">
                        <div class="form-horizontal">
                            ...
                            <div class='form-group'>
                                ...
                                <div class="col-md-2">
                                    <asp:DropDownList ID="ddl_Vendor" runat="server" class="form-control"></asp:DropDownList>
                                </div>
                            </div>
                            <div class='form-group'>
                                <div class="text-center">
                                    ...
                                    <%-- <div class="table-responsive" id="div_detail" runat="server">
                                        </div>--%>
                                        </ContentTemplate>
                                    </asp:UpdatePanel>
                                </div>
            ...
            <div style="background-color:#E6E6E6;position: absolute;top:0;left:0;width: 100%;height:300%;z-index:1001;-moz-opacity: 0.8;opacity:.80;filter: alpha(opacity=80);"><img src="../../images/loading_transparent.gif" style="background-color:Aqua;position:fixed; top:40%; left:46%;"/></div>
                ...
                <script src="../../JS/Vendor_Service_Invoice_Detail_Report.js"></script>
                <script>

<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Pending_Material_Inspection.aspx.cs" Inherits="Pending_Material_Inspection" %>
...
<body>
    <form id="form1" runat="server">
            ...
            <div class="col-md-12">
                <div class="panel panel-danger">
                    <div class="panel-heading">
                        ...
                        <h3 class="panel-title">Pending Material Inspection Report</h3>
                    </div>
                </div>
            </div>
            <div class="col-md-12" style="margin-top: -8px;">
                <div class="panel panel-grey">
                    <div class="panel-heading">
                        ...
                        <h4 class="panel-title">Pending Material Details</h4>
                    </div>
                    <div class="panel-body">
                      <div class="form-horizontal">
                       ...
                       <div class='form-group'>
                                ...
                                <div class="col-md-1"></div>
                                <label class="col-md-2">Material Code</label>
                                <div class="col-md-2">
                                    <asp:DropDownList ID="ddl_Material_Code" class="form-control" runat="server" ></asp:DropDownList>
                                </div>
                        </div>
                        <div class="form-group">
                            <div class="col-md-12 text-center">
                                <asp:Button type="button" ID="btnSubmit" Text="SUBMIT" runat="server" class="btn btn-danger btn-rounded" OnClick="btnsubmit_Click" OnClientClick="return Pending()"/>
        ...
        <script src="../../JS/Pending_Material_Inspection.js"></script>

...
public partial class Pending_Payment_Vendor : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        try
        {
            ...
            {
                AjaxPro.Utility.RegisterTypeForAjax(typeof(Pending_Payment_Vendor));
                if (!Page.IsPostBack)
                {
    ...
    protected string getUserData(string name, int pageno, int rpp)
    {
        ...
        try
        {
            ...
            html.Append("<thead><tr class='grey center'><th>#</th><th>Material Code</th><th>Material Text</th><th>Po No</th><th>Po Date</th><th>GR acceptance Date</th><th>Plant</th><th>Payment Terms</th><th>Invoice No</th><th>Invoice Date</th></tr></thead>");
            html.Append("<tbody>");
            DataTable dtData = (DataTable)ActionController.ExecuteAction("", "Material_Transit_Report.aspx", "getpendingpaymentsvendor", ref data, username, name);
            if (dtData != null)
            {
                int ddl = rpp;

<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Cash_Voucher.aspx.cs" Inherits="Cash_Voucher" %>
...
<body class="pace-top" style="overflow-x: hidden">
    ...
    <div class="row" style="border: 1px solid white; background: #ffffff;">
        ...
        <div class="row">
                ...
                <table style="font-size:small; margin-left:5%; width:90%; text-align:center">
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="clsBorder td1" style="border: 1px solid black;">Cash Location</td>
                            <td class="clsBorder td2" style="border: 1px solid black;"><span id="spn_Location" runat="server">NA</span></td>
            ...
            <br />
				<p style="font-weight:bold; width:100%; text-align:center">This is a system generated voucher and does not require signature.</p>

...
public partial class Car_Voucher : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        try
        {
            AjaxPro.Utility.RegisterTypeForAjax(typeof(Car_Voucher));
            if (!Page.IsPostBack)
            {
		...
		if (Convert.ToString(Request.QueryString["R"]) != "")
                {
                    ...
                    process_name = "CAR POLICY";
                    //req_no = "CAR-EXPENSE/2016-2017/3";

...
public partial class Bank_Voucher : System.Web.UI.Page
{
    ...
    protected void bindData(string process, string req_no)
    {
        ...
        if (dsData != null)
        {
         ...
         if (dtApprover != null)
         {
             ...
             sb.Append("<table style='font-size:small; width:100%'><tbody>");
            ...
            else
            {
             ...
             sb.Append("<table style='width:100%; font-size:smaller;'>");

<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Foreign_Voucher.aspx.cs" Inherits="Foreign_Voucher" %>
...
<head id="Head1" runat="server">
    ...
    <title>Foreign Travel Voucher</title>
                ...
                <table style="font-size:smaller; margin-left:5%; width:90%; text-align:center">
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="clsBorder td2" style="border: 1px solid black;"><span id="spn_Doc_Type" runat="server">J1</span></td>

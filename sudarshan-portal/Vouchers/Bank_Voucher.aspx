<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Bank_Voucher.aspx.cs" Inherits="Bank_Voucher" %>
...
<body class="pace-top" style="overflow-x: hidden">
    ...
    <div class="row" style="border: 1px solid white; background: #ffffff;">
        ...
        <div class="row">
                ...
                <table style="font-size:small; margin-left:5%; width:90%; text-align:center">
                    <tbody>
                        <tr>
                            <td colspan="4"></td>
                            <td>Date : </td>
            ...
            <br />
                <div id="tbl_Data" runat="server"  style="font-size:small; margin-left:5%; width:90%"></div>
            ...
            <br />
		<p style="font-weight:bold; width:100%; text-align:center; font-size:small">This is a system generated voucher and does not require signature.</p>
            <div style="width:100%; border-top:1px dotted black"></div>
            <br />
            <div class="col-md-12">
                <div  style='width: 90%; margin-left:5%; font-size:small' id="div_audit" runat="server"></div>
            </div>
        </div>

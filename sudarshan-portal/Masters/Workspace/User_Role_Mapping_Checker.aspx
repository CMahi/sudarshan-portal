<%@ Page Language="C#" AutoEventWireup="true" CodeFile="User_Role_Mapping_Checker.aspx.cs"
    Inherits="User_Role_Mapping_Checker" %>
...
<%--    <link href="/Sudarshan-Portal-NEW/css/helpdesk_style.css" rel="stylesheet" type="text/css" />
    ...
    <script language="JavaScript" type="text/javascript" src="/Sudarshan-Portal-NEW/JS/User_Role_Mapping_Checker.js"></script>
                                    ...
                                    <tr>
                                        <td align="center" style="width: 100%">
                                            <table id="tbl_Search" align="center" cellpadding="0" cellspacing="0" width="100%"
                                                ...
                                                <tr>
                                                    <td style="width: 100%">
                                                        <table id="Table1" align="center" cellpadding="0" cellspacing="0" width="50%" runat="server">
                                                            <tr>
                                                ...
                                                <tr>
                                                    <td align="center" style="width: 100%">
                                                        <div id="div_DiaplayResultSetUserRoleInfo" class="innocent_flowers" style="width: 90%"
                                                            runat="server">

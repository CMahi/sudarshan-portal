<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Government_Authority.aspx.cs" Inherits="Government_Authority" %>
...
<body>
    <form id="form1" runat="server">
            ...
            <div class="col-lg-12">
                <div class="panel panel-danger">
                    <div class="panel-heading">
                        <h4 class="panel-title"><b>Government Authority Master</b></h4>
                    </div>
                    <div class="panel-body">
                        <div class="col-md-12">
                            <div class="form-horizontal bordered-group">
                                <div class="form-group">
                                    <label class="col-md-2 control-label"><b>State Name</b><font color="red">*</font></label>
                                    <div class="col-md-2 ui-sortable">
                                        <asp:DropDownList ID="ddl_State" runat="server" CssClass="form-control">
                                        </asp:DropDownList>
                                    </div>
                                    <label class="col-md-2 control-label"><b>Authority Name</b><font color="red">*</font> </label>
                                    <div class="col-md-2 ui-sortable">
                                        <asp:TextBox ID="txt_Authority_Name" runat="server" CssClass="form-control"></asp:TextBox>
                                    </div>
            ...
            <div class="modal-dialog" style="height: auto; width: 50%; margin-left: 25%">
                <div class="modal-content">
                    <div class="modal-header">
                        ...
                        <h4 class="modal-title"><font color="white">Update Government Authority Details </font></h4>
                    </div>
                    ...
                    <div class="modal-body" id="div_header" runat="server">
                        <div class="col-md-12">
                            ...
                            <div class="col-md-5">
                                <asp:DropDownList ID="ddl_Edit_State" runat="server" CssClass="form-control">
                                </asp:DropDownList>
                            </div>
                            <div class="col-md-2"></div>
                        </div>
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="col-md-5">
                                <asp:TextBox ID="txt_Edit_Authority" runat="server" CssClass="form-control"></asp:TextBox>
                            </div>
                            <div class="col-md-2"></div>
                        </div>
                    </div>
        ...
        <div class="modal fade" id="DeletePanel">
            <div class="modal-dialog" style="height: auto; width: 36%; margin-left: 25%">
                <div class="modal-content">
                    <div class="modal-header">
                        <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
                        <h4 class="modal-title"><font color="white">Delete Government Authority Details </font></h4>
                    </div>
        ...
        <div class="col-md-12" id="div_ListCountryDetails">
            <div class="panel panel-danger">
                <div class="panel-heading">
                    <h4 class="panel-title"><b>Government Authority Master Details</b></h4>
                    <div class="btn-group pull-right" style="margin-top: -31px">
                        <div class="col-md-12">
                            <input id="txt_search" style="float: right" runat="server" onkeyup="getdata();" type="text" placeholder="Authority Name to Search" class="form-control" />
                        </div>
                    </div>
...
<script type="text/javascript">
    ...
    $("#btn_AddNew").click(function () {
        ...
        if ($("#txt_Authority_Name").val() == "") {
            alert('Validation Error:Please Enter Authority Name..!');
            return false;
        }
    });
    ...
    function getdata() {
        ...
        Government_Authority.bindData("5", Authority_Name, callbackuser_data);
    }
    ...
    function bindData(index) {
        $("#ddl_Edit_State").val($("#txt_FkState_ID" + index).val());
        $("#txt_Edit_Authority").val($("#txt_authority_name" + index).val());

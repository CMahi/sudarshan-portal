<%@ Page Language="C#" AutoEventWireup="true" CodeFile="LC_Level_Master.aspx.cs" Inherits="LC_Level_Master" %>
...
<body>
    <form id="form1" runat="server">
            ...
            <div class="col-lg-12">
                <div class="panel panel-danger">
                    <div class="panel-heading">
                        <h4 class="panel-title"><b>Level Master</b></h4>
                    </div>
                    <div class="panel-body">
                        <div class="col-md-12">
                            <div class="form-horizontal bordered-group">
                                <div class="form-group">
                                    <label class="col-md-2 control-label"><b>Level Name</b><font color="red">*</font> </label>
                                    <div class="col-md-2 ui-sortable">
                                        <asp:TextBox ID="txt_level_Name" runat="server" CssClass="form-control"></asp:TextBox>
                                    </div>
            ...
            <div class="modal-dialog" style="height: auto; width: 50%; margin-left: 25%">
                <div class="modal-content">
                    <div class="modal-header">
                        ...
                        <h4 class="modal-title"><font color="white">Update Level Master Details </font></h4>
                    </div>
                    ...
                    <div class="modal-body" id="div_header" runat="server">
                        <div class="col-md-12">
                            ...
                            <div class="col-md-5">
                                <asp:TextBox ID="txt_Edit_Level" runat="server" CssClass="form-control"></asp:TextBox>
                            </div>
                            <div class="col-md-2"></div>
                        </div>
                    </div>
        ...
        <div class="modal fade" id="DeletePanel">
            <div class="modal-dialog" style="height: auto; width: 36%; margin-left: 25%">
                <div class="modal-content">
                    <div class="modal-header">
                        <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
                        <h4 class="modal-title"><font color="white">Delete Level Master Details </font></h4>
                    </div>
        ...
        <div class="col-md-12" id="div_ListCountryDetails">
            <div class="panel panel-danger">
                <div class="panel-heading">
                    <h4 class="panel-title"><b>Level Master Details</b></h4>
                    <div class="btn-group pull-right" style="margin-top:-31px" >
                        <div class="col-md-12">
                            <input id="txt_search"  style="float: right" runat="server" onkeyup="getdata();" type="text" placeholder="Level Name to Search" class="form-control" />
                        </div>
                    </div>
...
<script type="text/javascript">
    ...
    $("#btn_AddNew").click(function () {
        if ($("#txt_level_Name").val() == "") {
            alert('Validation Error:Please Enter Level Name..!');
            return false;
        }
    });
    ...
    function getdata() {
        ...
        LC_Level_Master.bindData("5", State_Name, callbackuser_data);
    }
    ...
    function bindData(index) {
        $("#txt_Edit_Level").val($("#txt_level" + index).val());

<%@ Page Language="C#" AutoEventWireup="true" CodeFile="State_Master.aspx.cs" Inherits="State_Master" %>
...
<body>
    <form id="form1" runat="server">
            ...
            <div class="col-lg-12">
                <div class="panel panel-danger">
                    <div class="panel-heading">
                        <h4 class="panel-title"><b>State Master</b></h4>
                    </div>
                            ...
                            <div class="form-horizontal bordered-group">
                                <div class="form-group">
                                    ...
                                    <div class="col-md-2 ui-sortable">
                                        <asp:TextBox ID="txt_State_Name" runat="server" CssClass="form-control"></asp:TextBox>
                                    </div>
            ...
            <div class="modal-dialog" style="height: auto; width: 50%; margin-left: 25%">
                <div class="modal-content">
                    <div class="modal-header">
                        ...
                        <h4 class="modal-title"><font color="white">Update State Master Details </font></h4>
                    </div>
                    ...
                    <div class="modal-body" id="div_header" runat="server">
                        <div class="col-md-12">
                            ...
                            <div class="col-md-5">
                                <asp:TextBox ID="txt_Edit_State" runat="server" CssClass="form-control"></asp:TextBox>
                            </div>
                            <div class="col-md-2"></div>
                        </div>
                    </div>
        ...
        <div class="col-md-12" id="div_ListCountryDetails">
            <div class="panel panel-danger">
                <div class="panel-heading">
                    <h4 class="panel-title"><b>State Master Details</b></h4>
                    <div class="btn-group pull-right" style="margin-top:-31px" >
                        <div class="col-md-12">
                            <input id="txt_search"  style="float: right" runat="server" onkeyup="getdata();" type="text" placeholder="State Name to Search" class="form-control" />
                        </div>
                    </div>
...
<script type="text/javascript">
    ...
    $("#btn_AddNew").click(function () {
        if ($("#txt_State_Name").val() == "") {
            alert('Validation Error:Please Enter State Name..!');
            return false;
        }
    });
    ...
    function getdata() {
        ...
        State_Master.bindData("5", State_Name, callbackuser_data);
    }
    ...
    function bindData(index) {
        $("#txt_Edit_State").val($("#txt_state_name" + index).val());

<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Currency_Master.aspx.cs" Inherits="Currency_Master" %>
			...
			<div class="col-md-12">
				<div class="panel panel-danger">
					<div class="panel-heading">
                        <h4 class="panel-title"><b>Currency Master</b></h4>
					</div>
						...
						<div class="form-horizontal bordered-group">
							<div class="form-group">
								...
								<div class="col-md-2 ui-sortable">
                                    <asp:TextBox ID="currency_name" runat="server" CssClass="form-control input-sm"></asp:TextBox>
								</div>
                                <div class="col-md-1"></div>
								<label class="col-md-2 control-label"><b>Exchange Rate(In INR)</b></label>
								<div class="col-md-2 ui-sortable">
                                    <asp:TextBox ID="exc_rate" runat="server" CssClass="form-control input-sm">0</asp:TextBox>
								</div>
								</div>
							</div>
                        </div>
		...
		<div class="modal-dialog"  style="height:auto; width:81%; margin-left:9%">
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <h4 class="modal-title"><font color="white">Update Currency Details </font></h4>
                </div>
                ...
                <div class="modal-body" id="div_header" runat="server">
                    <div class="col-md-12">
							...
							<div class="form-group">
								...
								<label class="col-md-2 control-label"><b>Currency</b></label>
								<div class="col-md-2 ui-sortable">
                                    <asp:TextBox ID="ed_currency_name" runat="server" CssClass="form-control input-sm" ></asp:TextBox>
								</div>
                                <div class="col-md-1"></div>
								<label class="col-md-2 control-label"><b>Exchange Rate(In INR)</b></label>
								<div class="col-md-2 ui-sortable">
                                    <asp:TextBox ID="ed_exc_rate" runat="server" CssClass="form-control input-sm"></asp:TextBox>
								</div>
								</div>
       ...
       <div id="divDel" runat="server" style="display:none">
		...
		<div class="modal-dialog"  style="height:auto; width:36%; margin-left:25%">
            <div class="modal-content">
                <div class="modal-header">
                    <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
                    <h4 class="modal-title"><font color="white">Delete Currency Details </font></h4>
                </div>
                ...
                <div class="modal-body" id="div2" runat="server">
                    <div class="col-md-12">
                        <div class="col-md-1"></div>
                        <div class="col-md-10">
                            <font color="red"><b>You Want To Delete Selected Currency Details?</b></font>
                        </div>
                          <div class="col-md-1"></div>
                    </div>
                    <div class="row">&nbsp;</div>
        ...
        <div class="row">
           <div class="col-lg-12" id="div_ListCountryDetails" style="display:normal; margin-top:10px">
				<div class="panel panel-danger">
					<div class="panel-heading">
<%--                          <div class="panel-heading-btn">
							   <a href="javascript:;" class="btn btn-sm btn-inverse m-b-3" onclick="hide_List()" >Back</a>
						</div>--%>
						<h4 class="panel-title"><b>Currency Details</b></h4>
					</div>
					<div class="panel-body">
                        <div class="row">
    ...
    <script src="../../assets/plugins/jquery/jquery-2.1.1.min.js"></script>
        ...
        <script src="../../JS/Currency_Master.js"></script>
    </form>
</body>
